...
int decode_iclass_barriers(context *ctx, Instruction *dec)
{
	...
	if(CRm && op2==3 && Rt==0x1f) UNALLOCATED(ENC_UNALLOCATED_808_BARRIERS);
	if((CRm&3)==2 && op2==1 && Rt==0x1f && HasXS()) return DSB(ctx, dec); // -> DSB_BOn_barriers
	if((CRm&3)==3 && op2==1 && Rt==0x1f) UNALLOCATED(ENC_UNALLOCATED_809_BARRIERS);
	if((CRm&2)==2 && !op2 && Rt==0x1f) UNALLOCATED(ENC_UNALLOCATED_810_BARRIERS);
	...
	if(!(CRm&2) && !(op2&6) && Rt==0x1f) UNALLOCATED(ENC_UNALLOCATED_807_BARRIERS);
	if(Rt!=0x1f) UNALLOCATED(ENC_UNALLOCATED_806_BARRIERS);
	UNMATCHED;
}
...
int decode_iclass_compbranch_regs2(context *ctx, Instruction *dec)
{
	...
	if((cc&6)==4) UNALLOCATED(ENC_UNALLOCATED_811_COMPBRANCH_REGS2);
	UNMATCHED;
}
...
int decode_iclass_compbranch_imm(context *ctx, Instruction *dec)
{
	...
	if((cc&6)==4) UNALLOCATED(ENC_UNALLOCATED_812_COMPBRANCH_IMM);
	UNMATCHED;
}
...
int decode_iclass_compbranch_regs(context *ctx, Instruction *dec)
{
	...
	if((cc&6)==4) UNALLOCATED(ENC_UNALLOCATED_813_COMPBRANCH_REGS);
	UNMATCHED;
}
...
int decode_iclass_exception(context *ctx, Instruction *dec)
{
	...
	if(!opc && !op2 && !LL) UNALLOCATED(ENC_UNALLOCATED_820_EXCEPTION);
	...
	if(opc==1 && !op2 && LL) UNALLOCATED(ENC_UNALLOCATED_818_EXCEPTION);
	if(opc==2 && !op2 && !LL) return HLT(ctx, dec); // -> HLT_EX_exception
	if(opc==2 && !op2 && LL) UNALLOCATED(ENC_UNALLOCATED_817_EXCEPTION);
	...
	if((opc&3)==3 && !op2 && LL) UNALLOCATED(ENC_UNALLOCATED_816_EXCEPTION);
	if((opc&5)==5 && !op2 && !LL) UNALLOCATED(ENC_UNALLOCATED_819_EXCEPTION);
	if((opc&5)==4 && !op2) UNALLOCATED(ENC_UNALLOCATED_815_EXCEPTION);
	if(op2) UNALLOCATED(ENC_UNALLOCATED_814_EXCEPTION);
	UNMATCHED;
}
...
int decode_iclass_miscbranch(context *ctx, Instruction *dec)
{
	...
	if(!(opc&6) && op2!=0x1f) UNALLOCATED(ENC_UNALLOCATED_832_MISCBRANCH);
	if((opc&6)==2) UNALLOCATED(ENC_UNALLOCATED_831_MISCBRANCH);
	if((opc&4)==4) UNALLOCATED(ENC_UNALLOCATED_830_MISCBRANCH);
	UNMATCHED;
}
...
int decode_iclass_pstate(context *ctx, Instruction *dec)
{
	...
	if(Rt!=0x1f) UNALLOCATED(ENC_UNALLOCATED_833_PSTATE);
	UNMATCHED;
}
...
int decode_iclass_systeminstrswithreg(context *ctx, Instruction *dec)
{
	...
	if(!CRm && (op2&6)==2) UNALLOCATED(ENC_UNALLOCATED_836_SYSTEMINSTRSWITHREG);
	if(!CRm && (op2&4)==4) UNALLOCATED(ENC_UNALLOCATED_835_SYSTEMINSTRSWITHREG);
	if(CRm) UNALLOCATED(ENC_UNALLOCATED_834_SYSTEMINSTRSWITHREG);
	UNMATCHED;
}
...
int decode_iclass_syspairinstrs(context *ctx, Instruction *dec)
{
	...
	if(L) UNALLOCATED(ENC_UNALLOCATED_837_SYSPAIRINSTRS);
	UNMATCHED;
}
...
int decode_iclass_systemresult(context *ctx, Instruction *dec)
{
	...
	if(op1==3 && CRn==3 && !(CRm&14) && op2!=3) UNALLOCATED(ENC_UNALLOCATED_843_SYSTEMRESULT);
	if(op1==3 && CRn==3 && (CRm&14)==2) UNALLOCATED(ENC_UNALLOCATED_842_SYSTEMRESULT);
	if(op1==3 && CRn==3 && (CRm&12)==4) UNALLOCATED(ENC_UNALLOCATED_841_SYSTEMRESULT);
	if(op1==3 && CRn==3 && (CRm&8)==8) UNALLOCATED(ENC_UNALLOCATED_840_SYSTEMRESULT);
	if(op1==3 && CRn!=3) UNALLOCATED(ENC_UNALLOCATED_839_SYSTEMRESULT);
	if(op1!=3) UNALLOCATED(ENC_UNALLOCATED_838_SYSTEMRESULT);
	UNMATCHED;
}
...
int decode_iclass_branch_reg(context *ctx, Instruction *dec)
{
	...
	if((opc&14)==4 && op2==0x1f && !op3 && Rn==0x1f && op4) UNALLOCATED(ENC_UNALLOCATED_860_BRANCH_REG);
	if(opc==4 && op2==0x1f && (op3&0x3e)==2 && Rn==0x1f && op4==0x1d) UNALLOCATED(ENC_UNALLOCATED_868_BRANCH_REG);
	if(opc==4 && op2==0x1f && (op3&0x3e)==2 && Rn==0x1f && (op4&0x1d)==0x19) UNALLOCATED(ENC_UNALLOCATED_867_BRANCH_REG);
	if(opc==4 && op2==0x1f && (op3&0x3e)==2 && Rn==0x1f && (op4&0x19)==0x11) UNALLOCATED(ENC_UNALLOCATED_866_BRANCH_REG);
	if(opc==4 && op2==0x1f && (op3&0x3e)==2 && Rn==0x1f && (op4&0x11)==1) UNALLOCATED(ENC_UNALLOCATED_865_BRANCH_REG);
	...
	if(opc==1 && op2==0x1f && !op3 && op4) UNALLOCATED(ENC_UNALLOCATED_859_BRANCH_REG);
	...
	if(opc==5 && op2==0x1f && (op3&0x3e)==2 && Rn==0x1f && op4&1) UNALLOCATED(ENC_UNALLOCATED_861_BRANCH_REG);
	if(!(opc&13) && op2==0x1f && !op3 && op4) UNALLOCATED(ENC_UNALLOCATED_858_BRANCH_REG);
	if(opc==2 && op2==0x1f && (op3&0x3e)==2 && Rn!=0x1f) UNALLOCATED(ENC_UNALLOCATED_862_BRANCH_REG);
	if((opc&14)==4 && op2==0x1f && op3==1 && Rn==0x1f) UNALLOCATED(ENC_UNALLOCATED_857_BRANCH_REG);
	if((opc&14)==4 && op2==0x1f && (op3&0x3e)==2 && Rn==0x1f && !(op4&1)) UNALLOCATED(ENC_UNALLOCATED_864_BRANCH_REG);
	if(!(opc&14) && op2==0x1f && (op3&0x3e)==2 && op4!=0x1f) UNALLOCATED(ENC_UNALLOCATED_863_BRANCH_REG);
	if((opc&14)==4 && op2==0x1f && !(op3&0x3c) && Rn!=0x1f) UNALLOCATED(ENC_UNALLOCATED_853_BRANCH_REG);
	if(opc==1 && op2==0x1f && op3==1) UNALLOCATED(ENC_UNALLOCATED_856_BRANCH_REG);
	...
	if(!(opc&13) && op2==0x1f && op3==1) UNALLOCATED(ENC_UNALLOCATED_855_BRANCH_REG);
	if(opc==3 && op2==0x1f && !(op3&0x3c)) UNALLOCATED(ENC_UNALLOCATED_854_BRANCH_REG);
	if((opc&14)==8 && op2==0x1f && !(op3&0x3e)) UNALLOCATED(ENC_UNALLOCATED_851_BRANCH_REG);
	if((opc&14)==6 && op2==0x1f && !(op3&0x3c)) UNALLOCATED(ENC_UNALLOCATED_852_BRANCH_REG);
	if((opc&14)==10 && op2==0x1f && !(op3&0x3c)) UNALLOCATED(ENC_UNALLOCATED_850_BRANCH_REG);
	if((opc&12)==12 && op2==0x1f && !(op3&0x3c)) UNALLOCATED(ENC_UNALLOCATED_849_BRANCH_REG);
	if(op2==0x1f && (op3&0x3c)==4) UNALLOCATED(ENC_UNALLOCATED_848_BRANCH_REG);
	if(op2==0x1f && (op3&0x38)==8) UNALLOCATED(ENC_UNALLOCATED_847_BRANCH_REG);
	if(op2==0x1f && (op3&0x30)==0x10) UNALLOCATED(ENC_UNALLOCATED_846_BRANCH_REG);
	if(op2==0x1f && (op3&0x20)==0x20) UNALLOCATED(ENC_UNALLOCATED_845_BRANCH_REG);
	if(op2!=0x1f) UNALLOCATED(ENC_UNALLOCATED_844_BRANCH_REG);
	UNMATCHED;
}
...
int decode_iclass_memop_128(context *ctx, Instruction *dec)
{
	...
	if(S && o3 && !opc) UNALLOCATED(ENC_UNALLOCATED_872_MEMOP_128);
	if(!S && !o3 && !(opc&5)) UNALLOCATED(ENC_UNALLOCATED_871_MEMOP_128);
	if(S && !o3 && !(opc&4)) UNALLOCATED(ENC_UNALLOCATED_870_MEMOP_128);
	if((opc&4)==4) UNALLOCATED(ENC_UNALLOCATED_869_MEMOP_128);
	UNMATCHED;
}
...
int decode_iclass_asisdlse(context *ctx, Instruction *dec)
{
	...
	if(opcode==5) UNALLOCATED(ENC_UNALLOCATED_875_ASISDLSE);
	if((opcode&5)==1) UNALLOCATED(ENC_UNALLOCATED_874_ASISDLSE);
	if((opcode&12)==12) UNALLOCATED(ENC_UNALLOCATED_873_ASISDLSE);
	UNMATCHED;
}
...
int decode_iclass_asisdlsep(context *ctx, Instruction *dec)
{
	...
	if(opcode==5) UNALLOCATED(ENC_UNALLOCATED_878_ASISDLSEP);
	if((opcode&5)==1) UNALLOCATED(ENC_UNALLOCATED_877_ASISDLSEP);
	if((opcode&12)==12) UNALLOCATED(ENC_UNALLOCATED_876_ASISDLSEP);
	UNMATCHED;
}
...
int decode_iclass_asisdlso(context *ctx, Instruction *dec)
{
	...
	if(!R && o2 && opcode==4 && S && size==1) UNALLOCATED(ENC_UNALLOCATED_887_ASISDLSO);
	...
	if(!R && o2 && opcode==4 && size!=1) UNALLOCATED(ENC_UNALLOCATED_881_ASISDLSO);
	...
	if(!o2 && (opcode&6)==4 && S && size==1) UNALLOCATED(ENC_UNALLOCATED_886_ASISDLSO);
	...
	if(!R && o2 && opcode!=4) UNALLOCATED(ENC_UNALLOCATED_880_ASISDLSO);
	if(L && !o2 && (opcode&6)==6 && S) UNALLOCATED(ENC_UNALLOCATED_885_ASISDLSO);
	if(!o2 && (opcode&6)==2 && size&1) UNALLOCATED(ENC_UNALLOCATED_883_ASISDLSO);
	if(!o2 && (opcode&6)==4 && (size&2)==2) UNALLOCATED(ENC_UNALLOCATED_884_ASISDLSO);
	if(!L && !o2 && (opcode&6)==6) UNALLOCATED(ENC_UNALLOCATED_882_ASISDLSO);
	if(R && o2) UNALLOCATED(ENC_UNALLOCATED_879_ASISDLSO);
	UNMATCHED;
}
...
int decode_iclass_asisdlsop(context *ctx, Instruction *dec)
{
	...
	if((opcode&6)==4 && S && size==1) UNALLOCATED(ENC_UNALLOCATED_892_ASISDLSOP);
	if(L && (opcode&6)==6 && S) UNALLOCATED(ENC_UNALLOCATED_891_ASISDLSOP);
	if((opcode&6)==2 && size&1) UNALLOCATED(ENC_UNALLOCATED_889_ASISDLSOP);
	if((opcode&6)==4 && (size&2)==2) UNALLOCATED(ENC_UNALLOCATED_890_ASISDLSOP);
	if(!L && (opcode&6)==6) UNALLOCATED(ENC_UNALLOCATED_888_ASISDLSOP);
	UNMATCHED;
}
...
int decode_iclass_memop(context *ctx, Instruction *dec)
{
	...
	if(size==3 && !VR && !A && !R && Rs!=0x1f && o3 && (opc&3)==1) UNALLOCATED(ENC_UNALLOCATED_914_MEMOP);
	if(VR && !A && o3 && opc==1 && Rt==0x1f) UNALLOCATED(ENC_UNALLOCATED_898_MEMOP);
	if(VR && !A && o3 && (opc&6)==2 && Rt==0x1f) UNALLOCATED(ENC_UNALLOCATED_896_MEMOP);
	...
	if(size==3 && !VR && !A && R && o3 && opc==2) UNALLOCATED(ENC_UNALLOCATED_912_MEMOP);
	if(size==3 && !VR && !A && R && o3 && opc==3) UNALLOCATED(ENC_UNALLOCATED_911_MEMOP);
	...
	if(VR && !A && o3 && Rt!=0x1f) UNALLOCATED(ENC_UNALLOCATED_894_MEMOP);
	if(!(size&2) && !VR && !A && R && o3 && opc==5) UNALLOCATED(ENC_UNALLOCATED_906_MEMOP);
	if(!(size&2) && !VR && A && R && o3 && opc==5) UNALLOCATED(ENC_UNALLOCATED_904_MEMOP);
	if(size==2 && !VR && !A && o3 && opc==2) UNALLOCATED(ENC_UNALLOCATED_909_MEMOP);
	if(size==2 && !VR && !A && o3 && opc==3) UNALLOCATED(ENC_UNALLOCATED_908_MEMOP);
	if(size==3 && !VR && !A && R && o3 && (opc&3)==1) UNALLOCATED(ENC_UNALLOCATED_910_MEMOP);
	if(!VR && A && R && o3 && opc==4) UNALLOCATED(ENC_UNALLOCATED_903_MEMOP);
	if(!(size&2) && !VR && !R && o3 && opc==5) UNALLOCATED(ENC_UNALLOCATED_905_MEMOP);
	if(size==2 && !VR && !A && o3 && (opc&3)==1) UNALLOCATED(ENC_UNALLOCATED_907_MEMOP);
	if(!VR && !A && o3 && opc==4) UNALLOCATED(ENC_UNALLOCATED_913_MEMOP);
	if(!(size&2) && !VR && A && o3 && (opc&6)==6) UNALLOCATED(ENC_UNALLOCATED_902_MEMOP);
	if((size&2)==2 && !VR && A && o3 && (opc&3)==1) UNALLOCATED(ENC_UNALLOCATED_900_MEMOP);
	if(!VR && !A && o3 && (opc&6)==6) UNALLOCATED(ENC_UNALLOCATED_901_MEMOP);
	if(VR && !o3 && opc==1) UNALLOCATED(ENC_UNALLOCATED_897_MEMOP);
	if((size&2)==2 && !VR && A && o3 && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_899_MEMOP);
	if(VR && !o3 && (opc&6)==2) UNALLOCATED(ENC_UNALLOCATED_895_MEMOP);
	if(VR && A && o3) UNALLOCATED(ENC_UNALLOCATED_893_MEMOP);
	UNMATCHED;
}
...
int decode_iclass_memop_unpriv(context *ctx, Instruction *dec)
{
	...
	if(opc==2) UNALLOCATED(ENC_UNALLOCATED_917_MEMOP_UNPRIV);
	if(o3 && (opc&5)==1) UNALLOCATED(ENC_UNALLOCATED_916_MEMOP_UNPRIV);
	if((opc&4)==4) UNALLOCATED(ENC_UNALLOCATED_915_MEMOP_UNPRIV);
	UNMATCHED;
}
...
int decode_iclass_comswap(context *ctx, Instruction *dec)
{
	...
	if(Rt2!=0x1f) UNALLOCATED(ENC_UNALLOCATED_918_COMSWAP);
	UNMATCHED;
}
...
int decode_iclass_comswap_unpriv(context *ctx, Instruction *dec)
{
	...
	if(sz && Rt2!=0x1f) UNALLOCATED(ENC_UNALLOCATED_920_COMSWAP_UNPRIV);
	if(!sz) UNALLOCATED(ENC_UNALLOCATED_919_COMSWAP_UNPRIV);
	UNMATCHED;
}
...
int decode_iclass_comswappr(context *ctx, Instruction *dec)
{
	...
	if(Rt2!=0x1f) UNALLOCATED(ENC_UNALLOCATED_921_COMSWAPPR);
	UNMATCHED;
}
...
int decode_iclass_comswappr_unpriv(context *ctx, Instruction *dec)
{
	...
	if(sz && Rt2!=0x1f) UNALLOCATED(ENC_UNALLOCATED_923_COMSWAPPR_UNPRIV);
	if(!sz) UNALLOCATED(ENC_UNALLOCATED_922_COMSWAPPR_UNPRIV);
	UNMATCHED;
}
...
int decode_iclass_ldst_gcs(context *ctx, Instruction *dec)
{
	...
	if((opc&6)==2) UNALLOCATED(ENC_UNALLOCATED_925_LDST_GCS);
	if((opc&4)==4) UNALLOCATED(ENC_UNALLOCATED_924_LDST_GCS);
	UNMATCHED;
}
...
int decode_iclass_ldapstl_simd(context *ctx, Instruction *dec)
{
	...
	if(size && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_926_LDAPSTL_SIMD);
	UNMATCHED;
}
...
int decode_iclass_ldapstl_unscaled(context *ctx, Instruction *dec)
{
	...
	if(size==2 && opc==3) UNALLOCATED(ENC_UNALLOCATED_928_LDAPSTL_UNSCALED);
	...
	if(size==3 && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_927_LDAPSTL_UNSCALED);
	UNMATCHED;
}
...
int decode_iclass_ldapstl_writeback(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_929_LDAPSTL_WRITEBACK);
	UNMATCHED;
}
...
int decode_iclass_ldiappstilp(context *ctx, Instruction *dec)
{
	...
	if((size&2)==2 && (opc2&14)==2) UNALLOCATED(ENC_UNALLOCATED_933_LDIAPPSTILP);
	if((size&2)==2 && (opc2&12)==4) UNALLOCATED(ENC_UNALLOCATED_932_LDIAPPSTILP);
	if((size&2)==2 && (opc2&8)==8) UNALLOCATED(ENC_UNALLOCATED_931_LDIAPPSTILP);
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_930_LDIAPPSTILP);
	UNMATCHED;
}
...
int decode_iclass_loadlit(context *ctx, Instruction *dec)
{
	...
	if(opc==3 && VR) UNALLOCATED(ENC_UNALLOCATED_934_LOADLIT);
	UNMATCHED;
}
...
int decode_iclass_ldsttags(context *ctx, Instruction *dec)
{
	...
	if(opc!=1 && imm9 && !op2) UNALLOCATED(ENC_UNALLOCATED_935_LDSTTAGS);
...
int decode_iclass_ldstnapair_offs(context *ctx, Instruction *dec)
{
	...
	if(opc==1 && !VR) UNALLOCATED(ENC_UNALLOCATED_936_LDSTNAPAIR_OFFS);
	UNMATCHED;
}
...
int decode_iclass_ldst_immpost(context *ctx, Instruction *dec)
{
	...
	if(size==2 && !VR && opc==3) UNALLOCATED(ENC_UNALLOCATED_939_LDST_IMMPOST);
	...
	if(size==1 && VR && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_940_LDST_IMMPOST);
	if(size==2 && VR && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_938_LDST_IMMPOST);
	if(size==3 && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_937_LDST_IMMPOST);
	UNMATCHED;
}
...
int decode_iclass_ldst_immpre(context *ctx, Instruction *dec)
{
	...
	if(size==2 && !VR && opc==3) UNALLOCATED(ENC_UNALLOCATED_943_LDST_IMMPRE);
	...
	if(size==1 && VR && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_944_LDST_IMMPRE);
	if(size==2 && VR && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_942_LDST_IMMPRE);
	if(size==3 && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_941_LDST_IMMPRE);
	UNMATCHED;
}
...
int decode_iclass_ldst_pac(context *ctx, Instruction *dec)
{
	...
	if(size==3 && VR) UNALLOCATED(ENC_UNALLOCATED_946_LDST_PAC);
	if(size!=3) UNALLOCATED(ENC_UNALLOCATED_945_LDST_PAC);
	UNMATCHED;
}
...
int decode_iclass_ldst_regoff(context *ctx, Instruction *dec)
{
	...
	if(size==3 && !VR && opc==2 && !(option&2)) UNALLOCATED(ENC_UNALLOCATED_949_LDST_REGOFF);
	...
	if((size&2)==2 && !VR && opc==3) UNALLOCATED(ENC_UNALLOCATED_948_LDST_REGOFF);
	if(size && VR && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_947_LDST_REGOFF);
	UNMATCHED;
}
...
int decode_iclass_ldst_unpriv(context *ctx, Instruction *dec)
{
	...
	if(size==2 && !VR && opc==3) UNALLOCATED(ENC_UNALLOCATED_952_LDST_UNPRIV);
	if(size==3 && !VR && !opc) return STTR(ctx, dec); // -> STTR_64_ldst_unpriv
	if(size==3 && !VR && opc==1) return LDTR(ctx, dec); // -> LDTR_64_ldst_unpriv
	if(size==3 && !VR && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_951_LDST_UNPRIV);
	if(VR) UNALLOCATED(ENC_UNALLOCATED_950_LDST_UNPRIV);
	UNMATCHED;
}
...
int decode_iclass_ldst_unscaled(context *ctx, Instruction *dec)
{
	...
	if((size&2)==2 && !VR && opc==3) UNALLOCATED(ENC_UNALLOCATED_954_LDST_UNSCALED);
	if(size && VR && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_953_LDST_UNSCALED);
	UNMATCHED;
}
...
int decode_iclass_ldst_pos(context *ctx, Instruction *dec)
{
	...
	if((size&2)==2 && !VR && opc==3) UNALLOCATED(ENC_UNALLOCATED_956_LDST_POS);
	if(size && VR && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_955_LDST_POS);
	UNMATCHED;
}
...
int decode_iclass_memcms(context *ctx, Instruction *dec)
{
	...
	if(o0 && op1==3 && !op2 && HasMOPS()) return SETGP(ctx, dec); // -> SETGP_SET_memcms
	if(o0 && op1==3 && op2==1 && HasMOPS()) return SETGPT(ctx, dec); // -> SETGPT_SET_memcms
	if(o0 && op1==3 && op2==2 && HasMOPS()) return SETGPN(ctx, dec); // -> SETGPN_SET_memcms
	if(o0 && op1==3 && op2==3 && HasMOPS()) return SETGPTN(ctx, dec); // -> SETGPTN_SET_memcms
	if(o0 && op1==3 && op2==4 && HasMOPS()) return SETGP(ctx, dec); // -> SETGM_SET_memcms
	if(o0 && op1==3 && op2==5 && HasMOPS()) return SETGPT(ctx, dec); // -> SETGMT_SET_memcms
	if(o0 && op1==3 && op2==6 && HasMOPS()) return SETGPN(ctx, dec); // -> SETGMN_SET_memcms
	if(o0 && op1==3 && op2==7 && HasMOPS()) return SETGPTN(ctx, dec); // -> SETGMTN_SET_memcms
	if(o0 && op1==3 && op2==8 && HasMOPS()) return SETGP(ctx, dec); // -> SETGE_SET_memcms
	if(o0 && op1==3 && op2==9 && HasMOPS()) return SETGPT(ctx, dec); // -> SETGET_SET_memcms
	if(o0 && op1==3 && op2==10 && HasMOPS()) return SETGPN(ctx, dec); // -> SETGEN_SET_memcms
	if(o0 && op1==3 && op2==11 && HasMOPS()) return SETGPTN(ctx, dec); // -> SETGETN_SET_memcms
	if(op1==3 && (op2&12)==12) UNALLOCATED(ENC_UNALLOCATED_957_MEMCMS);
	UNMATCHED;
}
...
int decode_iclass_addsub_immtags(context *ctx, Instruction *dec)
{
	...
	if(sf && S) UNALLOCATED(ENC_UNALLOCATED_784_ADDSUB_IMMTAGS);
	if(!sf) UNALLOCATED(ENC_UNALLOCATED_783_ADDSUB_IMMTAGS);
	UNMATCHED;
}
...
int decode_iclass_bitfield(context *ctx, Instruction *dec)
{
	...
	if(!sf && opc==3 && !N) UNALLOCATED(ENC_UNALLOCATED_787_BITFIELD);
	...
	if(sf && opc==3 && N) UNALLOCATED(ENC_UNALLOCATED_788_BITFIELD);
	if(!sf && N) UNALLOCATED(ENC_UNALLOCATED_785_BITFIELD);
	if(sf && !N) UNALLOCATED(ENC_UNALLOCATED_786_BITFIELD);
	UNMATCHED;
}
...
int decode_iclass_dp_1src_imm(context *ctx, Instruction *dec)
{
	...
	if(sf && !(opc&2) && Rd!=0x1f) UNALLOCATED(ENC_UNALLOCATED_791_DP_1SRC_IMM);
	if(sf && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_790_DP_1SRC_IMM);
	if(!sf) UNALLOCATED(ENC_UNALLOCATED_789_DP_1SRC_IMM);
	UNMATCHED;
}
...
int decode_iclass_extract(context *ctx, Instruction *dec)
{
	...
	if(!sf && !op21 && !N && !o0 && (imms&0x20)==0x20) UNALLOCATED(ENC_UNALLOCATED_797_EXTRACT);
	if(!sf && !op21 && N && !o0) UNALLOCATED(ENC_UNALLOCATED_795_EXTRACT);
	if(sf && !op21 && !N && !o0) UNALLOCATED(ENC_UNALLOCATED_796_EXTRACT);
	if(sf && !op21 && N && !o0) return EXTR(ctx, dec); // -> EXTR_64_extract
	if(!op21 && o0) UNALLOCATED(ENC_UNALLOCATED_794_EXTRACT);
	if(op21==1) UNALLOCATED(ENC_UNALLOCATED_793_EXTRACT);
	if(op21==2) UNALLOCATED(ENC_UNALLOCATED_792_EXTRACT);
	UNMATCHED;
}
...
int decode_iclass_log_imm(context *ctx, Instruction *dec)
{
	...
	if(!sf && N) UNALLOCATED(ENC_UNALLOCATED_798_LOG_IMM);
	UNMATCHED;
}
...
int decode_iclass_minmax_imm(context *ctx, Instruction *dec)
{
	...
	if(!op && !S && (opc&12)==4) UNALLOCATED(ENC_UNALLOCATED_802_MINMAX_IMM);
	if(!op && !S && (opc&8)==8) UNALLOCATED(ENC_UNALLOCATED_801_MINMAX_IMM);
	if(!op && S) UNALLOCATED(ENC_UNALLOCATED_800_MINMAX_IMM);
	if(op) UNALLOCATED(ENC_UNALLOCATED_799_MINMAX_IMM);
	UNMATCHED;
}
...
int decode_iclass_movewide(context *ctx, Instruction *dec)
{
	...
	if(sf && opc==1 && (hw&2)==2) UNALLOCATED(ENC_UNALLOCATED_805_MOVEWIDE);
	if(opc==1 && !(hw&2)) UNALLOCATED(ENC_UNALLOCATED_804_MOVEWIDE);
	...
	if(!sf && (hw&2)==2) UNALLOCATED(ENC_UNALLOCATED_803_MOVEWIDE);
	UNMATCHED;
}
...
int decode_iclass_addsub_pt(context *ctx, Instruction *dec)
{
	...
	if(sf && S) UNALLOCATED(ENC_UNALLOCATED_959_ADDSUB_PT);
	if(!sf) UNALLOCATED(ENC_UNALLOCATED_958_ADDSUB_PT);
	UNMATCHED;
}
...
int decode_iclass_addsub_ext(context *ctx, Instruction *dec)
{
	...
	if(opt) UNALLOCATED(ENC_UNALLOCATED_960_ADDSUB_EXT);
	UNMATCHED;
}
...
int decode_iclass_condcmp_imm(context *ctx, Instruction *dec)
{
	...
	if(S && !o2 && o3) UNALLOCATED(ENC_UNALLOCATED_963_CONDCMP_IMM);
	if(S && o2) UNALLOCATED(ENC_UNALLOCATED_962_CONDCMP_IMM);
	if(!S) UNALLOCATED(ENC_UNALLOCATED_961_CONDCMP_IMM);
	UNMATCHED;
}
...
int decode_iclass_condcmp_reg(context *ctx, Instruction *dec)
{
	...
	if(S && !o2 && o3) UNALLOCATED(ENC_UNALLOCATED_966_CONDCMP_REG);
	if(S && o2) UNALLOCATED(ENC_UNALLOCATED_965_CONDCMP_REG);
	if(!S) UNALLOCATED(ENC_UNALLOCATED_964_CONDCMP_REG);
	UNMATCHED;
}
...
int decode_iclass_condsel(context *ctx, Instruction *dec)
{
	...
	if(!S && (op2&2)==2) UNALLOCATED(ENC_UNALLOCATED_968_CONDSEL);
	if(S) UNALLOCATED(ENC_UNALLOCATED_967_CONDSEL);
	UNMATCHED;
}
...
int decode_iclass_dp_1src(context *ctx, Instruction *dec)
{
	...
	if(sf && !S && opcode2==1 && (opcode&0x3e)==0x2a && Rn==0x1f && Rd==0x1e) UNALLOCATED(ENC_UNALLOCATED_991_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x3e)==0x2c && Rn==0x1f && Rd==0x1e) UNALLOCATED(ENC_UNALLOCATED_992_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x3c)==0x20 && Rn!=0x1f && Rd==0x1e) UNALLOCATED(ENC_UNALLOCATED_988_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x38)==0x28 && Rn!=0x1f && Rd==0x1e) UNALLOCATED(ENC_UNALLOCATED_987_DP_1SRC);
	...
	if(sf && !S && opcode2==1 && (opcode&0x3e)==0x10 && Rn!=0x1f) UNALLOCATED(ENC_UNALLOCATED_982_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x3e)==0x26 && Rd==0x1e) UNALLOCATED(ENC_UNALLOCATED_990_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x38)==8 && Rn!=0x1f) UNALLOCATED(ENC_UNALLOCATED_986_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x30)==0x20 && Rd!=0x1e) UNALLOCATED(ENC_UNALLOCATED_978_DP_1SRC);
	...
	if(!sf && !S && !opcode2 && opcode==3) UNALLOCATED(ENC_UNALLOCATED_989_DP_1SRC);
	...
	if(!S && !opcode2 && opcode==9) UNALLOCATED(ENC_UNALLOCATED_985_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x3e)==0x12) UNALLOCATED(ENC_UNALLOCATED_981_DP_1SRC);
	if(!S && !opcode2 && (opcode&0x3e)==10) UNALLOCATED(ENC_UNALLOCATED_984_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x3c)==0x14) UNALLOCATED(ENC_UNALLOCATED_980_DP_1SRC);
	if(!S && !opcode2 && (opcode&0x3c)==12) UNALLOCATED(ENC_UNALLOCATED_983_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x38)==0x18) UNALLOCATED(ENC_UNALLOCATED_979_DP_1SRC);
	if(sf && !S && opcode2==1 && (opcode&0x30)==0x30) UNALLOCATED(ENC_UNALLOCATED_977_DP_1SRC);
	if(!S && !opcode2 && (opcode&0x30)==0x10) UNALLOCATED(ENC_UNALLOCATED_976_DP_1SRC);
	if(!S && !opcode2 && (opcode&0x20)==0x20) UNALLOCATED(ENC_UNALLOCATED_975_DP_1SRC);
	if(!sf && !S && opcode2==1) UNALLOCATED(ENC_UNALLOCATED_974_DP_1SRC);
	if(!S && (opcode2&0x1e)==2) UNALLOCATED(ENC_UNALLOCATED_973_DP_1SRC);
	if(!S && (opcode2&0x1c)==4) UNALLOCATED(ENC_UNALLOCATED_972_DP_1SRC);
	if(!S && (opcode2&0x18)==8) UNALLOCATED(ENC_UNALLOCATED_971_DP_1SRC);
	if(!S && (opcode2&0x10)==0x10) UNALLOCATED(ENC_UNALLOCATED_970_DP_1SRC);
	if(S) UNALLOCATED(ENC_UNALLOCATED_969_DP_1SRC);
	UNMATCHED;
}
...
int decode_iclass_dp_2src(context *ctx, Instruction *dec)
{
	...
	if(sf && !S && opcode==13) UNALLOCATED(ENC_UNALLOCATED_1002_DP_2SRC);
	if(sf && !S && opcode==0x11) UNALLOCATED(ENC_UNALLOCATED_1009_DP_2SRC);
	if(sf && !S && opcode==0x13 && HasCRC32()) return CRC32(ctx, dec); // -> CRC32X_64C_dp_2src
	if(sf && !S && opcode==0x15) UNALLOCATED(ENC_UNALLOCATED_1006_DP_2SRC);
	...
	if(!sf && !S && (opcode&0x3e)==4) UNALLOCATED(ENC_UNALLOCATED_1004_DP_2SRC);
	if(!sf && !S && (opcode&0x3b)==0x13) UNALLOCATED(ENC_UNALLOCATED_1007_DP_2SRC);
	if(sf && opcode==1) UNALLOCATED(ENC_UNALLOCATED_1008_DP_2SRC);
	if(sf && !S && (opcode&0x3e)==14) UNALLOCATED(ENC_UNALLOCATED_1000_DP_2SRC);
	if(!S && (opcode&0x3e)==6) UNALLOCATED(ENC_UNALLOCATED_999_DP_2SRC);
	if(S && (opcode&0x3e)==2) UNALLOCATED(ENC_UNALLOCATED_997_DP_2SRC);
	if(!sf && !(opcode&0x3e)) UNALLOCATED(ENC_UNALLOCATED_1003_DP_2SRC);
	if(sf && !S && (opcode&0x39)==0x10) UNALLOCATED(ENC_UNALLOCATED_1005_DP_2SRC);
	if(sf && !S && (opcode&0x3c)==0x1c) UNALLOCATED(ENC_UNALLOCATED_1001_DP_2SRC);
	if(S && (opcode&0x3c)==4) UNALLOCATED(ENC_UNALLOCATED_996_DP_2SRC);
	if(!sf && !S && (opcode&0x2c)==12) UNALLOCATED(ENC_UNALLOCATED_998_DP_2SRC);
	if(S && (opcode&0x38)==8) UNALLOCATED(ENC_UNALLOCATED_995_DP_2SRC);
	if(S && (opcode&0x30)==0x10) UNALLOCATED(ENC_UNALLOCATED_994_DP_2SRC);
	if((opcode&0x20)==0x20) UNALLOCATED(ENC_UNALLOCATED_993_DP_2SRC);
	UNMATCHED;
}
...
int decode_iclass_dp_3src(context *ctx, Instruction *dec)
{
	...
	if(sf && !op54 && (op31&3)==2 && o0) UNALLOCATED(ENC_UNALLOCATED_1015_DP_3SRC);
	if(sf && !op54 && op31==7) UNALLOCATED(ENC_UNALLOCATED_1014_DP_3SRC);
	if(!op54 && op31==4) UNALLOCATED(ENC_UNALLOCATED_1013_DP_3SRC);
	if(!sf && !op54 && (op31&3)==1) UNALLOCATED(ENC_UNALLOCATED_1012_DP_3SRC);
	if(!sf && !op54 && (op31&2)==2) UNALLOCATED(ENC_UNALLOCATED_1011_DP_3SRC);
	if(op54) UNALLOCATED(ENC_UNALLOCATED_1010_DP_3SRC);
	UNMATCHED;
}
...
int decode_iclass_setf(context *ctx, Instruction *dec)
{
	...
	if(!sf && !op && S && !opcode2 && !o3 && mask!=13) UNALLOCATED(ENC_UNALLOCATED_1021_SETF);
	if(!sf && !op && S && !opcode2 && o3) UNALLOCATED(ENC_UNALLOCATED_1020_SETF);
	if(!sf && !op && S && opcode2) UNALLOCATED(ENC_UNALLOCATED_1019_SETF);
	if(!sf && !op && !S) UNALLOCATED(ENC_UNALLOCATED_1018_SETF);
	if(!sf && op) UNALLOCATED(ENC_UNALLOCATED_1017_SETF);
	if(sf) UNALLOCATED(ENC_UNALLOCATED_1016_SETF);
	UNMATCHED;
}
...
int decode_iclass_rmif(context *ctx, Instruction *dec)
{
	...
	if(sf && !op && S && o2) UNALLOCATED(ENC_UNALLOCATED_1025_RMIF);
	if(sf && !op && !S) UNALLOCATED(ENC_UNALLOCATED_1024_RMIF);
	if(sf && op) UNALLOCATED(ENC_UNALLOCATED_1023_RMIF);
	if(!sf) UNALLOCATED(ENC_UNALLOCATED_1022_RMIF);
	UNMATCHED;
}
...
int decode_iclass_asimdall(context *ctx, Instruction *dec)
{
	...
	if(!Q && U && !(size&1) && opcode==15) UNALLOCATED(ENC_UNALLOCATED_1036_ASIMDALL);
	if(Q && U && !(size&1) && opcode==14) UNALLOCATED(ENC_UNALLOCATED_1039_ASIMDALL);
	if(!U && !(size&1) && opcode==14) UNALLOCATED(ENC_UNALLOCATED_1038_ASIMDALL);
	if(!Q && U && !(size&1) && (opcode&0x1d)==12) UNALLOCATED(ENC_UNALLOCATED_1035_ASIMDALL);
	if(!(size&1) && opcode==13) UNALLOCATED(ENC_UNALLOCATED_1034_ASIMDALL);
	...
	if(U && opcode==0x1b) UNALLOCATED(ENC_UNALLOCATED_1037_ASIMDALL);
	if(opcode==1) UNALLOCATED(ENC_UNALLOCATED_1033_ASIMDALL);
	if(opcode==11) UNALLOCATED(ENC_UNALLOCATED_1040_ASIMDALL);
	if(!(opcode&0x1d)) UNALLOCATED(ENC_UNALLOCATED_1031_ASIMDALL);
	if(!(size&1) && (opcode&0x1c)==4) UNALLOCATED(ENC_UNALLOCATED_1030_ASIMDALL);
	if(!(size&1) && (opcode&0x1c)==0x14) UNALLOCATED(ENC_UNALLOCATED_1028_ASIMDALL);
	if(!(size&1) && (opcode&0x1c)==0x1c) UNALLOCATED(ENC_UNALLOCATED_1029_ASIMDALL);
	if((opcode&14)==8) UNALLOCATED(ENC_UNALLOCATED_1032_ASIMDALL);
	if((opcode&0x1c)==0x10) UNALLOCATED(ENC_UNALLOCATED_1027_ASIMDALL);
	if(size&1 && (opcode&4)==4) UNALLOCATED(ENC_UNALLOCATED_1026_ASIMDALL);
	UNMATCHED;
}
...
int decode_iclass_asimdins(context *ctx, Instruction *dec)
{
	...
	if(Q && !op && (imm5&15)==9 && imm4==7) UNALLOCATED(ENC_UNALLOCATED_1049_ASIMDINS);
	if(Q && !op && (imm5&14)==10 && imm4==7) UNALLOCATED(ENC_UNALLOCATED_1048_ASIMDINS);
	if(Q && !op && (imm5&12)==12 && imm4==7) UNALLOCATED(ENC_UNALLOCATED_1047_ASIMDINS);
	if(Q && !op && !(imm5&8) && imm4==7) UNALLOCATED(ENC_UNALLOCATED_1046_ASIMDINS);
	...
	if(Q && !op && imm4==2) UNALLOCATED(ENC_UNALLOCATED_1045_ASIMDINS);
	...
	if(!Q && !op && (imm4&14)==2) UNALLOCATED(ENC_UNALLOCATED_1043_ASIMDINS);
	if(!op && (imm4&13)==4) UNALLOCATED(ENC_UNALLOCATED_1044_ASIMDINS);
	if(!op && (imm4&8)==8) UNALLOCATED(ENC_UNALLOCATED_1042_ASIMDINS);
	if(!Q && op) UNALLOCATED(ENC_UNALLOCATED_1041_ASIMDINS);
...
int decode_iclass_asimdext(context *ctx, Instruction *dec)
{
	...
	if(op2) UNALLOCATED(ENC_UNALLOCATED_1050_ASIMDEXT);
	UNMATCHED;
}
...
int decode_iclass_asimdimm(context *ctx, Instruction *dec)
{
	...
	if(!Q && op && cmode==15 && !o2) UNALLOCATED(ENC_UNALLOCATED_1053_ASIMDIMM);
	...
	if(!op && cmode!=15 && o2) UNALLOCATED(ENC_UNALLOCATED_1052_ASIMDIMM);
	...
	if(op && o2) UNALLOCATED(ENC_UNALLOCATED_1051_ASIMDIMM);
	UNMATCHED;
}
...
int decode_iclass_asimdperm(context *ctx, Instruction *dec)
{
	...
	if(!(opcode&3)) UNALLOCATED(ENC_UNALLOCATED_1054_ASIMDPERM);
	UNMATCHED;
}
...
int decode_iclass_asisdone(context *ctx, Instruction *dec)
{
	...
	if(!op && imm4) UNALLOCATED(ENC_UNALLOCATED_1056_ASISDONE);
	if(op) UNALLOCATED(ENC_UNALLOCATED_1055_ASISDONE);
	UNMATCHED;
}
...
int decode_iclass_asisdpair(context *ctx, Instruction *dec)
{
	...
	if(!U && size==3 && opcode==11) UNALLOCATED(ENC_UNALLOCATED_1066_ASISDPAIR);
	if(!U && size==3 && opcode==0x1b && HasAdvSIMD()) return ADDP_advsimd_pair(ctx, dec); // -> ADDP_asisdpair_only
	if(U && size==3 && opcode==13) UNALLOCATED(ENC_UNALLOCATED_1068_ASISDPAIR);
	if(size==2 && opcode==13) UNALLOCATED(ENC_UNALLOCATED_1067_ASISDPAIR);
	if(!U && size&1 && opcode==12) UNALLOCATED(ENC_UNALLOCATED_1065_ASISDPAIR);
	if(!U && size==3 && (opcode&15)==10) UNALLOCATED(ENC_UNALLOCATED_1063_ASISDPAIR);
	...
	if(!U && size&1 && (opcode&0x1d)==13) UNALLOCATED(ENC_UNALLOCATED_1064_ASISDPAIR);
	if(!U && size==3 && (opcode&14)==8) UNALLOCATED(ENC_UNALLOCATED_1061_ASISDPAIR);
	if(opcode==14) UNALLOCATED(ENC_UNALLOCATED_1062_ASISDPAIR);
	if(!U && size!=3 && (opcode&12)==8) UNALLOCATED(ENC_UNALLOCATED_1059_ASISDPAIR);
	if((opcode&0x1c)==0x1c) UNALLOCATED(ENC_UNALLOCATED_1060_ASISDPAIR);
	if(U && (opcode&12)==8) UNALLOCATED(ENC_UNALLOCATED_1058_ASISDPAIR);
	if(!(opcode&8)) UNALLOCATED(ENC_UNALLOCATED_1057_ASISDPAIR);
	UNMATCHED;
}
...
int decode_iclass_asisdshf(context *ctx, Instruction *dec)
{
	...
	if(U && !immh && opcode==12) UNALLOCATED(ENC_UNALLOCATED_1081_ASISDSHF);
	...
	if(!immh && opcode==0x1c) UNALLOCATED(ENC_UNALLOCATED_1080_ASISDSHF);
	if(!immh && opcode==0x1f) UNALLOCATED(ENC_UNALLOCATED_1083_ASISDSHF);
	if(immh && opcode==0x1e) UNALLOCATED(ENC_UNALLOCATED_1085_ASISDSHF);
	if(U && !immh && (opcode&0x1e)==0x10) UNALLOCATED(ENC_UNALLOCATED_1084_ASISDSHF);
	if(!immh && (opcode&15)==14) UNALLOCATED(ENC_UNALLOCATED_1079_ASISDSHF);
	if(!immh && (opcode&0x1e)==0x12) UNALLOCATED(ENC_UNALLOCATED_1082_ASISDSHF);
	...
	if(!U && (immh&8)==8 && opcode==8) UNALLOCATED(ENC_UNALLOCATED_1077_ASISDSHF);
	...
	if(!U && opcode==12) UNALLOCATED(ENC_UNALLOCATED_1076_ASISDSHF);
	if(opcode==0x1d) UNALLOCATED(ENC_UNALLOCATED_1075_ASISDSHF);
	if(!(immh&8) && (opcode&0x1d)==0x19) UNALLOCATED(ENC_UNALLOCATED_1072_ASISDSHF);
	if(!U && (opcode&0x1e)==0x10) UNALLOCATED(ENC_UNALLOCATED_1078_ASISDSHF);
	if(!(immh&8) && (opcode&13)==8) UNALLOCATED(ENC_UNALLOCATED_1071_ASISDSHF);
	if(!(immh&8) && !(opcode&0x19)) UNALLOCATED(ENC_UNALLOCATED_1070_ASISDSHF);
	if((immh&8)==8 && (opcode&0x1c)==0x18) UNALLOCATED(ENC_UNALLOCATED_1074_ASISDSHF);
	if((opcode&0x1c)==0x14) UNALLOCATED(ENC_UNALLOCATED_1073_ASISDSHF);
	if((opcode&0x11)==1) UNALLOCATED(ENC_UNALLOCATED_1069_ASISDSHF);
	UNMATCHED;
}
...
int decode_iclass_asisddiff(context *ctx, Instruction *dec)
{
	...
	if(!U && opcode==15) UNALLOCATED(ENC_UNALLOCATED_1089_ASISDDIFF);
	if(!U && (opcode&9)==8) UNALLOCATED(ENC_UNALLOCATED_1088_ASISDDIFF);
	if(!U && !(opcode&8)) UNALLOCATED(ENC_UNALLOCATED_1087_ASISDDIFF);
	if(U) UNALLOCATED(ENC_UNALLOCATED_1086_ASISDDIFF);
	UNMATCHED;
}
...
int decode_iclass_asisdsame(context *ctx, Instruction *dec)
{
	...
	if(size==1 && opcode==6) UNALLOCATED(ENC_UNALLOCATED_1101_ASISDSAME);
	if(size==3 && !opcode) UNALLOCATED(ENC_UNALLOCATED_1106_ASISDSAME);
	if(size==3 && opcode==2) UNALLOCATED(ENC_UNALLOCATED_1097_ASISDSAME);
	if(size==3 && opcode==0x15) UNALLOCATED(ENC_UNALLOCATED_1108_ASISDSAME);
	if(size!=2 && opcode==0x14) UNALLOCATED(ENC_UNALLOCATED_1103_ASISDSAME);
	if(size!=3 && opcode==7) UNALLOCATED(ENC_UNALLOCATED_1100_ASISDSAME);
	...
	if(!U && (size&2)==2 && opcode==0x1a) UNALLOCATED(ENC_UNALLOCATED_1113_ASISDSAME);
	if(!U && (size&2)==2 && opcode==0x1b) UNALLOCATED(ENC_UNALLOCATED_1115_ASISDSAME);
	if(!U && (size&2)==2 && opcode==0x1c) UNALLOCATED(ENC_UNALLOCATED_1112_ASISDSAME);
	...
	if(size&1 && opcode==4) UNALLOCATED(ENC_UNALLOCATED_1105_ASISDSAME);
	if((size&2)==2 && opcode==0x12) UNALLOCATED(ENC_UNALLOCATED_1096_ASISDSAME);
	if((size&2)==2 && opcode==0x18) UNALLOCATED(ENC_UNALLOCATED_1110_ASISDSAME);
	...
	if(!U && opcode==0x1d) UNALLOCATED(ENC_UNALLOCATED_1114_ASISDSAME);
	...
	if(U && opcode==0x1b) UNALLOCATED(ENC_UNALLOCATED_1099_ASISDSAME);
	if(opcode==0x19) UNALLOCATED(ENC_UNALLOCATED_1109_ASISDSAME);
	if(opcode==0x1e) UNALLOCATED(ENC_UNALLOCATED_1111_ASISDSAME);
	if(size&1 && (opcode&0x1d)==12) UNALLOCATED(ENC_UNALLOCATED_1094_ASISDSAME);
	if(!(size&2) && (opcode&0x1b)==0x11) UNALLOCATED(ENC_UNALLOCATED_1102_ASISDSAME);
	if(size==2 && !(opcode&0x15)) UNALLOCATED(ENC_UNALLOCATED_1092_ASISDSAME);
	if(size==2 && (opcode&0x1a)==0x10) UNALLOCATED(ENC_UNALLOCATED_1104_ASISDSAME);
	if(U && (opcode&0x17)==0x17) UNALLOCATED(ENC_UNALLOCATED_1098_ASISDSAME);
	if((opcode&15)==3) UNALLOCATED(ENC_UNALLOCATED_1095_ASISDSAME);
	if((opcode&0x1d)==13) UNALLOCATED(ENC_UNALLOCATED_1093_ASISDSAME);
	if(!(size&1) && (opcode&0x15)==4) UNALLOCATED(ENC_UNALLOCATED_1091_ASISDSAME);
	if(!(size&2) && !(opcode&5)) UNALLOCATED(ENC_UNALLOCATED_1090_ASISDSAME);
	UNMATCHED;
}
...
int decode_iclass_asisdsamefp16(context *ctx, Instruction *dec)
{
	...
	if(!U && !a && opcode==6) UNALLOCATED(ENC_UNALLOCATED_1123_ASISDSAMEFP16);
	if(!U && !a && opcode==7 && HasAdvSIMD() && HasFP16()) return FRECPS_advsimd(ctx, dec); // -> FRECPS_asisdsamefp16_only
	if(!U && a && opcode==3) UNALLOCATED(ENC_UNALLOCATED_1124_ASISDSAMEFP16);
	if(!U && a && opcode==4) UNALLOCATED(ENC_UNALLOCATED_1118_ASISDSAMEFP16);
	...
	if(!a && opcode==2) UNALLOCATED(ENC_UNALLOCATED_1122_ASISDSAMEFP16);
	if(!U && opcode==5) UNALLOCATED(ENC_UNALLOCATED_1119_ASISDSAMEFP16);
	if(!U && a && (opcode&3)==2) UNALLOCATED(ENC_UNALLOCATED_1117_ASISDSAMEFP16);
	if(U && opcode==3) UNALLOCATED(ENC_UNALLOCATED_1121_ASISDSAMEFP16);
	if(U && (opcode&6)==6) UNALLOCATED(ENC_UNALLOCATED_1120_ASISDSAMEFP16);
	if(!(opcode&6)) UNALLOCATED(ENC_UNALLOCATED_1116_ASISDSAMEFP16);
	UNMATCHED;
}
...
int decode_iclass_asisdsame2(context *ctx, Instruction *dec)
{
	...
	if(U && (opcode&14)==2) UNALLOCATED(ENC_UNALLOCATED_1128_ASISDSAME2);
	if(U && (opcode&12)==4) UNALLOCATED(ENC_UNALLOCATED_1127_ASISDSAME2);
	if(U && (opcode&8)==8) UNALLOCATED(ENC_UNALLOCATED_1126_ASISDSAME2);
	if(!U) UNALLOCATED(ENC_UNALLOCATED_1125_ASISDSAME2);
	UNMATCHED;
}
...
{
	uint32_t U=(INSWORD>>29)&1, size=(INSWORD>>22)&3, opcode=(INSWORD>>12)&0x1f;
	if(!U && size==2 && opcode==10) UNALLOCATED(ENC_UNALLOCATED_1140_ASISDMISC);
	...
	if(U && !size && opcode==0x16) UNALLOCATED(ENC_UNALLOCATED_1145_ASISDMISC);
	...
	if(size==2 && opcode==8) UNALLOCATED(ENC_UNALLOCATED_1139_ASISDMISC);
	...
	if(!U && (size&2)==2 && opcode==0x1e) UNALLOCATED(ENC_UNALLOCATED_1144_ASISDMISC);
	...
	if(U && (size&2)==2 && opcode==0x1f) UNALLOCATED(ENC_UNALLOCATED_1142_ASISDMISC);
	if((size&2)==2 && opcode==15) UNALLOCATED(ENC_UNALLOCATED_1146_ASISDMISC);
	if((size&2)==2 && opcode==0x1c) UNALLOCATED(ENC_UNALLOCATED_1143_ASISDMISC);
	if(size==2 && (opcode&0x1d)==9) UNALLOCATED(ENC_UNALLOCATED_1138_ASISDMISC);
	...
	if(U && (size&2)==2 && (opcode&0x1b)==10) UNALLOCATED(ENC_UNALLOCATED_1136_ASISDMISC);
	if(U && (size&2)==2 && (opcode&0x17)==0x16) UNALLOCATED(ENC_UNALLOCATED_1141_ASISDMISC);
	if(opcode==0x19) UNALLOCATED(ENC_UNALLOCATED_1133_ASISDMISC);
	if(!(size&2) && (opcode&0x1e)==0x1e) UNALLOCATED(ENC_UNALLOCATED_1137_ASISDMISC);
	if(U && (opcode&0x1b)==2) UNALLOCATED(ENC_UNALLOCATED_1135_ASISDMISC);
	if((opcode&0x17)==0x10) UNALLOCATED(ENC_UNALLOCATED_1132_ASISDMISC);
	if(!U && (opcode&11)==2) UNALLOCATED(ENC_UNALLOCATED_1134_ASISDMISC);
	if(!(opcode&0x1a)) UNALLOCATED(ENC_UNALLOCATED_1130_ASISDMISC);
	if((opcode&0x19)==0x11) UNALLOCATED(ENC_UNALLOCATED_1131_ASISDMISC);
	if(!(size&2) && (opcode&0x18)==8) UNALLOCATED(ENC_UNALLOCATED_1129_ASISDMISC);
	UNMATCHED;
}
...
int decode_iclass_asisdmiscfp16(context *ctx, Instruction *dec)
{
	...
	if(!U && a && opcode==15) UNALLOCATED(ENC_UNALLOCATED_1154_ASISDMISCFP16);
	...
	if(!U && a && opcode==0x1e) UNALLOCATED(ENC_UNALLOCATED_1156_ASISDMISCFP16);
	...
	if(a && opcode==0x1c) UNALLOCATED(ENC_UNALLOCATED_1155_ASISDMISCFP16);
	if(!U && !a && (opcode&0x1e)==0x1e) UNALLOCATED(ENC_UNALLOCATED_1153_ASISDMISCFP16);
	if(U && a && (opcode&0x1e)==14) UNALLOCATED(ENC_UNALLOCATED_1152_ASISDMISCFP16);
	if(U && (opcode&0x1e)==0x1e) UNALLOCATED(ENC_UNALLOCATED_1151_ASISDMISCFP16);
	if((opcode&0x1e)==0x18) UNALLOCATED(ENC_UNALLOCATED_1150_ASISDMISCFP16);
	if(a && (opcode&0x1c)==8) UNALLOCATED(ENC_UNALLOCATED_1149_ASISDMISCFP16);
	if(!a && (opcode&0x18)==8) UNALLOCATED(ENC_UNALLOCATED_1148_ASISDMISCFP16);
	if(!(opcode&8)) UNALLOCATED(ENC_UNALLOCATED_1147_ASISDMISCFP16);
	UNMATCHED;
}
...
int decode_iclass_asisdelem(context *ctx, Instruction *dec)
{
	...
	if(size==1 && opcode==9) UNALLOCATED(ENC_UNALLOCATED_1164_ASISDELEM);
	if(!U && size==1 && (opcode&11)==1) UNALLOCATED(ENC_UNALLOCATED_1163_ASISDELEM);
	...
	if(U && opcode==11) UNALLOCATED(ENC_UNALLOCATED_1161_ASISDELEM);
	...
	if(!U && (opcode&13)==8) UNALLOCATED(ENC_UNALLOCATED_1160_ASISDELEM);
	if(!U && (opcode&14)==14) UNALLOCATED(ENC_UNALLOCATED_1162_ASISDELEM);
	if(!U && !(opcode&9)) UNALLOCATED(ENC_UNALLOCATED_1159_ASISDELEM);
	if(U && (opcode&9)==8) UNALLOCATED(ENC_UNALLOCATED_1158_ASISDELEM);
	if(U && !(opcode&8)) UNALLOCATED(ENC_UNALLOCATED_1157_ASISDELEM);
	UNMATCHED;
}
...
int decode_iclass_asimdshf(context *ctx, Instruction *dec)
{
	...
	if(immh && opcode==0x1d) UNALLOCATED(ENC_UNALLOCATED_1168_ASIMDSHF);
	if(!U && immh && (opcode&0x1b)==8) UNALLOCATED(ENC_UNALLOCATED_1169_ASIMDSHF);
	if(immh && (opcode&0x17)==0x16) UNALLOCATED(ENC_UNALLOCATED_1170_ASIMDSHF);
	if(immh && (opcode&0x1d)==0x15) UNALLOCATED(ENC_UNALLOCATED_1167_ASIMDSHF);
	if(immh && (opcode&0x1c)==0x18) UNALLOCATED(ENC_UNALLOCATED_1166_ASIMDSHF);
	if(immh && (opcode&0x11)==1) UNALLOCATED(ENC_UNALLOCATED_1165_ASIMDSHF);
	UNMATCHED;
}
...
int decode_iclass_asimdtbl(context *ctx, Instruction *dec)
{
	...
	if(Q && op2==1 && !(len&1) && !op) UNALLOCATED(ENC_UNALLOCATED_1173_ASIMDTBL);
	...
	if(Q && op2==2 && !op) UNALLOCATED(ENC_UNALLOCATED_1172_ASIMDTBL);
	if(Q && op2==2 && op && HasAdvSIMD() && HasLUT()) return LUTI2_advsimd(ctx, dec); // -> LUTI2_asimdtbl_L5
	if(!Q && op2) UNALLOCATED(ENC_UNALLOCATED_1171_ASIMDTBL);
...
int decode_iclass_asimddiff(context *ctx, Instruction *dec)
{
	...
	if(!U && opcode==15) UNALLOCATED(ENC_UNALLOCATED_1176_ASIMDDIFF);
	...
	if(U && opcode==14) UNALLOCATED(ENC_UNALLOCATED_1175_ASIMDDIFF);
	if(U && (opcode&9)==9) UNALLOCATED(ENC_UNALLOCATED_1174_ASIMDDIFF);
	UNMATCHED;
}
...
int decode_iclass_asimdsame(context *ctx, Instruction *dec)
{
	...
	if(!U && size&1 && opcode==0x1d) UNALLOCATED(ENC_UNALLOCATED_1179_ASIMDSAME);
	...
	if(!U && (size&2)==2 && opcode==0x1c) UNALLOCATED(ENC_UNALLOCATED_1178_ASIMDSAME);
	...
	if(U && size&1 && opcode==0x19) UNALLOCATED(ENC_UNALLOCATED_1180_ASIMDSAME);
	...
	if(U && opcode==0x17) UNALLOCATED(ENC_UNALLOCATED_1177_ASIMDSAME);
	UNMATCHED;
}
...
int decode_iclass_asimdsamefp16(context *ctx, Instruction *dec)
{
	...
	if(!U && !a && opcode==5) UNALLOCATED(ENC_UNALLOCATED_1182_ASIMDSAMEFP16);
	...
	if(!U && a && (opcode&6)==4) UNALLOCATED(ENC_UNALLOCATED_1181_ASIMDSAMEFP16);
	if(U && opcode==1) UNALLOCATED(ENC_UNALLOCATED_1183_ASIMDSAMEFP16);
	UNMATCHED;
}
...
int decode_iclass_asimdsame2(context *ctx, Instruction *dec)
{
	...
	if(Q && !U && size==3 && opcode==13) UNALLOCATED(ENC_UNALLOCATED_1198_ASIMDSAME2);
	if(Q && !U && size==3 && opcode==15 && HasFP8FMA()) return FMLALB_advsimd_vec(ctx, dec); // -> FMLALT_asimdsame2_J
	if(Q && !U && size!=3 && opcode==13) UNALLOCATED(ENC_UNALLOCATED_1192_ASIMDSAME2);
	...
	if(Q && U && size==2 && opcode==5) UNALLOCATED(ENC_UNALLOCATED_1199_ASIMDSAME2);
	if(Q && U && size==2 && opcode==13 && HasF8F32MM()) return FMMLA_FP8FP32(ctx, dec); // -> FMMLA_asimd_FP8FP32
	if(Q && U && size==3 && opcode==13) UNALLOCATED(ENC_UNALLOCATED_1202_ASIMDSAME2);
	...
	if(!U && size==2 && opcode==1) UNALLOCATED(ENC_UNALLOCATED_1195_ASIMDSAME2);
	if(!U && size==2 && opcode==3 && HasI8MM()) return USDOT_advsimd_vec(ctx, dec); // -> USDOT_asimdsame2_D
	if(!U && size==2 && opcode==9) UNALLOCATED(ENC_UNALLOCATED_1191_ASIMDSAME2);
	...
	if(!U && !(size&2) && opcode==10) UNALLOCATED(ENC_UNALLOCATED_1196_ASIMDSAME2);
	if(!U && !(size&2) && opcode==12) UNALLOCATED(ENC_UNALLOCATED_1197_ASIMDSAME2);
	if(!U && size==2 && (opcode&11)==11) UNALLOCATED(ENC_UNALLOCATED_1190_ASIMDSAME2);
	if(U && !(size&1) && opcode==15) UNALLOCATED(ENC_UNALLOCATED_1201_ASIMDSAME2);
	if(Q && size==2 && (opcode&14)==6) UNALLOCATED(ENC_UNALLOCATED_1186_ASIMDSAME2);
	if(!U && !opcode) UNALLOCATED(ENC_UNALLOCATED_1194_ASIMDSAME2);
	if(!U && opcode==2 && HasDotProd()) return SDOT_advsimd_vec(ctx, dec); // -> SDOT_asimdsame2_D
	if(!U && size==2 && (opcode&9)==8) UNALLOCATED(ENC_UNALLOCATED_1189_ASIMDSAME2);
	if(!U && size==3 && (opcode&9)==8) UNALLOCATED(ENC_UNALLOCATED_1193_ASIMDSAME2);
	if(!U && size!=2 && (opcode&5)==1) UNALLOCATED(ENC_UNALLOCATED_1188_ASIMDSAME2);
	...
	if(U && opcode==3) UNALLOCATED(ENC_UNALLOCATED_1200_ASIMDSAME2);
	if(!Q && opcode==13) UNALLOCATED(ENC_UNALLOCATED_1187_ASIMDSAME2);
	if(Q && size!=2 && (opcode&12)==4) UNALLOCATED(ENC_UNALLOCATED_1185_ASIMDSAME2);
	...
	if(!Q && (opcode&12)==4) UNALLOCATED(ENC_UNALLOCATED_1184_ASIMDSAME2);
	UNMATCHED;
}
...
int decode_iclass_asimdmisc(context *ctx, Instruction *dec)
{
	...
	if(size==2 && opcode==0x1e) UNALLOCATED(ENC_UNALLOCATED_1214_ASIMDMISC);
	...
	if(U && !(size&1) && opcode==0x16) UNALLOCATED(ENC_UNALLOCATED_1215_ASIMDMISC);
	if(U && !(size&2) && opcode==1) UNALLOCATED(ENC_UNALLOCATED_1210_ASIMDMISC);
	...
	if(U && (size&2)==2 && opcode==14) UNALLOCATED(ENC_UNALLOCATED_1209_ASIMDMISC);
	if(U && (size&2)==2 && opcode==15 && HasAdvSIMD()) return FNEG_advsimd(ctx, dec); // -> FNEG_asimdmisc_R
	if(U && (size&2)==2 && opcode==0x18) UNALLOCATED(ENC_UNALLOCATED_1212_ASIMDMISC);
	...
	if(size==3 && (opcode&0x17)==0x16) UNALLOCATED(ENC_UNALLOCATED_1213_ASIMDMISC);
	...
	if(!U && opcode==0x13) UNALLOCATED(ENC_UNALLOCATED_1206_ASIMDMISC);
	if(!U && opcode==0x14 && HasAdvSIMD()) return SQXTN_advsimd(ctx, dec); // -> SQXTN_asimdmisc_N
	if(!U && (size&2)==2 && (opcode&0x17)==0x17) UNALLOCATED(ENC_UNALLOCATED_1211_ASIMDMISC);
	...
	if(U && opcode==10) UNALLOCATED(ENC_UNALLOCATED_1208_ASIMDMISC);
	...
	if(U && (size&2)==2 && (opcode&0x1b)==1) UNALLOCATED(ENC_UNALLOCATED_1207_ASIMDMISC);
	if(opcode==0x15) UNALLOCATED(ENC_UNALLOCATED_1205_ASIMDMISC);
	if((opcode&0x1e)==0x10) UNALLOCATED(ENC_UNALLOCATED_1204_ASIMDMISC);
	if(!(size&2) && (opcode&0x1c)==12) UNALLOCATED(ENC_UNALLOCATED_1203_ASIMDMISC);
	UNMATCHED;
}
...
int decode_iclass_asimdmiscfp16(context *ctx, Instruction *dec)
{
	...
	if(U && a && opcode==0x18) UNALLOCATED(ENC_UNALLOCATED_1223_ASIMDMISCFP16);
	...
	if(a && opcode==0x1c) UNALLOCATED(ENC_UNALLOCATED_1222_ASIMDMISCFP16);
	if(!U && a && (opcode&0x1e)==0x1e) UNALLOCATED(ENC_UNALLOCATED_1220_ASIMDMISCFP16);
	if(U && a && (opcode&15)==14) UNALLOCATED(ENC_UNALLOCATED_1221_ASIMDMISCFP16);
	if(!a && (opcode&0x1e)==0x1e) UNALLOCATED(ENC_UNALLOCATED_1219_ASIMDMISCFP16);
	if(a && (opcode&0x1c)==8) UNALLOCATED(ENC_UNALLOCATED_1218_ASIMDMISCFP16);
	if(!a && (opcode&0x18)==8) UNALLOCATED(ENC_UNALLOCATED_1217_ASIMDMISCFP16);
	if(!(opcode&8)) UNALLOCATED(ENC_UNALLOCATED_1216_ASIMDMISCFP16);
	UNMATCHED;
}
...
int decode_iclass_asimdelem(context *ctx, Instruction *dec)
{
	...
	if(!U && size!=2 && opcode==4) UNALLOCATED(ENC_UNALLOCATED_1226_ASIMDELEM);
	...
	if(size==1 && opcode==9) UNALLOCATED(ENC_UNALLOCATED_1229_ASIMDELEM);
	if(!U && size==1 && (opcode&11)==1) UNALLOCATED(ENC_UNALLOCATED_1225_ASIMDELEM);
	...
	if(U && !(size&2) && opcode==12) UNALLOCATED(ENC_UNALLOCATED_1227_ASIMDELEM);
	if(U && (size&2)==2 && opcode==9 && HasAdvSIMD()) return FMULX_advsimd_elt(ctx, dec); // -> FMULX_asimdelem_R_SD
	if(U && size==3 && (opcode&11)==8) UNALLOCATED(ENC_UNALLOCATED_1228_ASIMDELEM);
	...
	if(U && opcode==11) UNALLOCATED(ENC_UNALLOCATED_1224_ASIMDELEM);
...
int decode_iclass_float2fix(context *ctx, Instruction *dec)
{
	...
	if(!S && ftype!=2 && rmode&1 && (opcode&6)==2) UNALLOCATED(ENC_UNALLOCATED_1235_FLOAT2FIX);
	if(!S && ftype!=2 && !(rmode&2) && !(opcode&6)) UNALLOCATED(ENC_UNALLOCATED_1233_FLOAT2FIX);
	if(!S && ftype!=2 && rmode==2 && !(opcode&4)) UNALLOCATED(ENC_UNALLOCATED_1234_FLOAT2FIX);
	if(!S && ftype==2 && !(opcode&4)) UNALLOCATED(ENC_UNALLOCATED_1232_FLOAT2FIX);
	if(!S && (opcode&4)==4) UNALLOCATED(ENC_UNALLOCATED_1231_FLOAT2FIX);
	if(S) UNALLOCATED(ENC_UNALLOCATED_1230_FLOAT2FIX);
	UNMATCHED;
}
...
int decode_iclass_float2int(context *ctx, Instruction *dec)
{
	...
	if(!sf && !S && ftype==1 && rmode==3 && opcode==7) UNALLOCATED(ENC_UNALLOCATED_1250_FLOAT2INT);
	...
	if(!sf && !S && !ftype && rmode && (opcode&6)==2) UNALLOCATED(ENC_UNALLOCATED_1242_FLOAT2INT);
	if(!sf && !S && ftype==2 && rmode==3 && (opcode&6)==6) UNALLOCATED(ENC_UNALLOCATED_1241_FLOAT2INT);
	if(!S && ftype!=2 && rmode==1 && (opcode&6)==4) UNALLOCATED(ENC_UNALLOCATED_1244_FLOAT2INT);
	if(!sf && !S && !(ftype&1) && rmode==1 && (opcode&6)==6) UNALLOCATED(ENC_UNALLOCATED_1243_FLOAT2INT);
	if(!sf && !S && ftype==1 && !(rmode&2) && (opcode&6)==6) UNALLOCATED(ENC_UNALLOCATED_1251_FLOAT2INT);
	if(sf && !S && !(ftype&1) && rmode==3 && (opcode&6)==6) UNALLOCATED(ENC_UNALLOCATED_1249_FLOAT2INT);
	if(sf && !S && !ftype && !(rmode&2) && (opcode&6)==6) UNALLOCATED(ENC_UNALLOCATED_1252_FLOAT2INT);
	if(sf && !S && ftype==1 && rmode==1 && (opcode&2)==2) UNALLOCATED(ENC_UNALLOCATED_1247_FLOAT2INT);
	if(sf && !S && ftype==1 && (rmode&2)==2 && (opcode&6)==2) UNALLOCATED(ENC_UNALLOCATED_1246_FLOAT2INT);
	if(!S && ftype==2 && rmode&1 && (opcode&6)==4) UNALLOCATED(ENC_UNALLOCATED_1239_FLOAT2INT);
	if(!S && ftype==3 && rmode&1 && (opcode&6)==6) UNALLOCATED(ENC_UNALLOCATED_1248_FLOAT2INT);
	if(!sf && !S && !ftype && (rmode&2)==2 && (opcode&4)==4) UNALLOCATED(ENC_UNALLOCATED_1240_FLOAT2INT);
	if(sf && !S && ftype==1 && (rmode&2)==2 && (opcode&4)==4) UNALLOCATED(ENC_UNALLOCATED_1245_FLOAT2INT);
	if(!S && ftype==2 && rmode&1 && !(opcode&4)) UNALLOCATED(ENC_UNALLOCATED_1238_FLOAT2INT);
	if(!S && ftype==2 && !(rmode&1)) UNALLOCATED(ENC_UNALLOCATED_1237_FLOAT2INT);
	if(S) UNALLOCATED(ENC_UNALLOCATED_1236_FLOAT2INT);
	UNMATCHED;
}
...
int decode_iclass_cryptoaes(context *ctx, Instruction *dec)
{
	...
	if(!size && !(opcode&0x1c)) UNALLOCATED(ENC_UNALLOCATED_1256_CRYPTOAES);
	if(!size && (opcode&0x18)==8) UNALLOCATED(ENC_UNALLOCATED_1255_CRYPTOAES);
	if(!size && (opcode&0x10)==0x10) UNALLOCATED(ENC_UNALLOCATED_1254_CRYPTOAES);
	if(size) UNALLOCATED(ENC_UNALLOCATED_1253_CRYPTOAES);
	UNMATCHED;
}
...
int decode_iclass_crypto4(context *ctx, Instruction *dec)
{
	...
	if(Op0==3) UNALLOCATED(ENC_UNALLOCATED_1257_CRYPTO4);
	UNMATCHED;
}
...
int decode_iclass_cryptosha3(context *ctx, Instruction *dec)
{
	...
	if(!size && opcode==7) UNALLOCATED(ENC_UNALLOCATED_1259_CRYPTOSHA3);
	if(size) UNALLOCATED(ENC_UNALLOCATED_1258_CRYPTOSHA3);
	UNMATCHED;
}
...
int decode_iclass_cryptosha512_3(context *ctx, Instruction *dec)
{
	...
	if(O && opcode==3) UNALLOCATED(ENC_UNALLOCATED_1260_CRYPTOSHA512_3);
	UNMATCHED;
}
...
int decode_iclass_cryptosha2(context *ctx, Instruction *dec)
{
	...
	if(!size && opcode==3) UNALLOCATED(ENC_UNALLOCATED_1265_CRYPTOSHA2);
	if(!size && (opcode&0x1c)==4) UNALLOCATED(ENC_UNALLOCATED_1264_CRYPTOSHA2);
	if(!size && (opcode&0x18)==8) UNALLOCATED(ENC_UNALLOCATED_1263_CRYPTOSHA2);
	if(!size && (opcode&0x10)==0x10) UNALLOCATED(ENC_UNALLOCATED_1262_CRYPTOSHA2);
	if(size) UNALLOCATED(ENC_UNALLOCATED_1261_CRYPTOSHA2);
	UNMATCHED;
}
...
int decode_iclass_cryptosha512_2(context *ctx, Instruction *dec)
{
	...
	if((opcode&2)==2) UNALLOCATED(ENC_UNALLOCATED_1266_CRYPTOSHA512_2);
	UNMATCHED;
}
...
int decode_iclass_floatcmp(context *ctx, Instruction *dec)
{
	...
	if(!M && !S && ftype==2 && !op && !(opcode2&7)) UNALLOCATED(ENC_UNALLOCATED_1273_FLOATCMP);
	if(!M && !S && !op && (opcode2&7)==1) UNALLOCATED(ENC_UNALLOCATED_1272_FLOATCMP);
	if(!M && !S && !op && (opcode2&6)==2) UNALLOCATED(ENC_UNALLOCATED_1271_FLOATCMP);
	if(!M && !S && !op && (opcode2&4)==4) UNALLOCATED(ENC_UNALLOCATED_1270_FLOATCMP);
	if(!M && !S && op) UNALLOCATED(ENC_UNALLOCATED_1269_FLOATCMP);
	if(!M && S) UNALLOCATED(ENC_UNALLOCATED_1268_FLOATCMP);
	if(M) UNALLOCATED(ENC_UNALLOCATED_1267_FLOATCMP);
	UNMATCHED;
}
...
int decode_iclass_floatccmp(context *ctx, Instruction *dec)
{
	...
	if(!M && !S && ftype==2) UNALLOCATED(ENC_UNALLOCATED_1276_FLOATCCMP);
	if(!M && S) UNALLOCATED(ENC_UNALLOCATED_1275_FLOATCCMP);
	if(M) UNALLOCATED(ENC_UNALLOCATED_1274_FLOATCCMP);
	UNMATCHED;
}
...
int decode_iclass_floatsel(context *ctx, Instruction *dec)
{
	...
	if(!M && !S && ftype==2) UNALLOCATED(ENC_UNALLOCATED_1279_FLOATSEL);
	if(!M && !S && ftype==3 && HasFP16()) return FCSEL_float(ctx, dec); // -> FCSEL_H_floatsel
	if(!M && S) UNALLOCATED(ENC_UNALLOCATED_1278_FLOATSEL);
	if(M) UNALLOCATED(ENC_UNALLOCATED_1277_FLOATSEL);
	UNMATCHED;
}
...
int decode_iclass_floatdp1(context *ctx, Instruction *dec)
{
	...
	if(!M && !S && ftype==1 && opcode==5) UNALLOCATED(ENC_UNALLOCATED_1290_FLOATDP1);
	...
	if(!M && !S && ftype!=2 && opcode==13) UNALLOCATED(ENC_UNALLOCATED_1289_FLOATDP1);
	if(!M && !S && !ftype && (opcode&0x3d)==4) UNALLOCATED(ENC_UNALLOCATED_1288_FLOATDP1);
	if(!M && !S && ftype==3 && (opcode&0x3e)==6) UNALLOCATED(ENC_UNALLOCATED_1287_FLOATDP1);
	if(!M && !S && !(ftype&2) && (opcode&0x3c)==0x14) UNALLOCATED(ENC_UNALLOCATED_1286_FLOATDP1);
	if(!M && !S && !(ftype&2) && (opcode&0x38)==0x18) UNALLOCATED(ENC_UNALLOCATED_1285_FLOATDP1);
	if(!M && !S && ftype==3 && (opcode&0x30)==0x10) UNALLOCATED(ENC_UNALLOCATED_1284_FLOATDP1);
	if(!M && !S && ftype==2 && !(opcode&0x20)) UNALLOCATED(ENC_UNALLOCATED_1283_FLOATDP1);
	if(!M && !S && (opcode&0x20)==0x20) UNALLOCATED(ENC_UNALLOCATED_1282_FLOATDP1);
	if(!M && S) UNALLOCATED(ENC_UNALLOCATED_1281_FLOATDP1);
	if(M) UNALLOCATED(ENC_UNALLOCATED_1280_FLOATDP1);
	UNMATCHED;
}
...
int decode_iclass_floatdp2(context *ctx, Instruction *dec)
{
	...
	if(!M && !S && ftype!=2 && opcode==9) UNALLOCATED(ENC_UNALLOCATED_1296_FLOATDP2);
	if(!M && !S && ftype!=2 && (opcode&14)==10) UNALLOCATED(ENC_UNALLOCATED_1295_FLOATDP2);
	if(!M && !S && ftype!=2 && (opcode&12)==12) UNALLOCATED(ENC_UNALLOCATED_1294_FLOATDP2);
	if(!M && !S && ftype==2) UNALLOCATED(ENC_UNALLOCATED_1293_FLOATDP2);
	if(!M && S) UNALLOCATED(ENC_UNALLOCATED_1292_FLOATDP2);
	if(M) UNALLOCATED(ENC_UNALLOCATED_1291_FLOATDP2);
	UNMATCHED;
}
...
int decode_iclass_floatdp3(context *ctx, Instruction *dec)
{
	...
	if(!M && !S && ftype==2) UNALLOCATED(ENC_UNALLOCATED_1299_FLOATDP3);
	if(!M && S) UNALLOCATED(ENC_UNALLOCATED_1298_FLOATDP3);
	if(M) UNALLOCATED(ENC_UNALLOCATED_1297_FLOATDP3);
	UNMATCHED;
}
...
int decode_iclass_floatimm(context *ctx, Instruction *dec)
{
	...
	if(!M && !S && ftype==2 && !imm5) UNALLOCATED(ENC_UNALLOCATED_1303_FLOATIMM);
	if(!M && !S && ftype==3 && !imm5 && HasFP16()) return FMOV_float_imm(ctx, dec); // -> FMOV_H_floatimm
	if(!M && !S && imm5) UNALLOCATED(ENC_UNALLOCATED_1302_FLOATIMM);
	if(!M && S) UNALLOCATED(ENC_UNALLOCATED_1301_FLOATIMM);
	if(M) UNALLOCATED(ENC_UNALLOCATED_1300_FLOATIMM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_addhv(context *ctx, Instruction *dec)
{
	...
	if(!op && (opc2&4)==4) UNALLOCATED(ENC_UNALLOCATED_692_MORTLACH_ADDHV);
...
int decode_iclass_mortlach_zt_ldst(context *ctx, Instruction *dec)
{
	...
	if((opc&0x1f)==0x1f && opc2) UNALLOCATED(ENC_UNALLOCATED_698_MORTLACH_ZT_LDST);
	if((opc&0x1f)==0x1e) UNALLOCATED(ENC_UNALLOCATED_697_MORTLACH_ZT_LDST);
	if((opc&0x1e)==0x1c) UNALLOCATED(ENC_UNALLOCATED_696_MORTLACH_ZT_LDST);
	if((opc&0x1c)==0x18) UNALLOCATED(ENC_UNALLOCATED_695_MORTLACH_ZT_LDST);
	if((opc&0x18)==0x10) UNALLOCATED(ENC_UNALLOCATED_694_MORTLACH_ZT_LDST);
	if(!(opc&0x10)) UNALLOCATED(ENC_UNALLOCATED_693_MORTLACH_ZT_LDST);
	UNMATCHED;
}
...
int decode_iclass_mortlach_extract_pred(context *ctx, Instruction *dec)
{
	...
	if(size!=3 && Q) UNALLOCATED(ENC_UNALLOCATED_699_MORTLACH_EXTRACT_PRED);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_extract_ctg(context *ctx, Instruction *dec)
{
	...
	if(size!=3 && (opc&4)==4) UNALLOCATED(ENC_UNALLOCATED_700_MORTLACH_MULTI4_EXTRACT_CTG);
...
int decode_iclass_mortlach_extract_zero(context *ctx, Instruction *dec)
{
	...
	if(size!=3 && Q) UNALLOCATED(ENC_UNALLOCATED_701_MORTLACH_EXTRACT_ZERO);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_extract_zero(context *ctx, Instruction *dec)
{
	...
	if(size!=3 && (opc&4)==4) UNALLOCATED(ENC_UNALLOCATED_702_MORTLACH_MULTI4_EXTRACT_ZERO);
...
int decode_iclass_mortlach_insert_pred(context *ctx, Instruction *dec)
{
	...
	if(size!=3 && Q) UNALLOCATED(ENC_UNALLOCATED_703_MORTLACH_INSERT_PRED);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_insert_ctg(context *ctx, Instruction *dec)
{
	...
	if(size!=3 && (opc&4)==4) UNALLOCATED(ENC_UNALLOCATED_704_MORTLACH_MULTI4_INSERT_CTG);
...
int decode_iclass_mortlach_expand_2dst_ctg(context *ctx, Instruction *dec)
{
	...
	if(!(opc&12) && !opc2) UNALLOCATED(ENC_UNALLOCATED_706_MORTLACH_EXPAND_2DST_CTG);
	...
	if(opc2) UNALLOCATED(ENC_UNALLOCATED_705_MORTLACH_EXPAND_2DST_CTG);
	UNMATCHED;
}
...
int decode_iclass_mortlach_expand_4dst_ctg(context *ctx, Instruction *dec)
{
	...
	if(!(opc&6) && !opc2) UNALLOCATED(ENC_UNALLOCATED_708_MORTLACH_EXPAND_4DST_CTG);
	...
	if(opc2) UNALLOCATED(ENC_UNALLOCATED_707_MORTLACH_EXPAND_4DST_CTG);
	UNMATCHED;
}
...
int decode_iclass_mortlach_expand_1dst(context *ctx, Instruction *dec)
{
	...
	if(!(opc&0x18) && !opc2) UNALLOCATED(ENC_UNALLOCATED_710_MORTLACH_EXPAND_1DST);
	...
	if(opc2) UNALLOCATED(ENC_UNALLOCATED_709_MORTLACH_EXPAND_1DST);
	UNMATCHED;
}
...
int decode_iclass_mortlach_expand_4dst2src_ctg(context *ctx, Instruction *dec)
{
	...
	if(opc) UNALLOCATED(ENC_UNALLOCATED_711_MORTLACH_EXPAND_4DST2SRC_CTG);
	UNMATCHED;
}
...
{
	uint32_t opc=(INSWORD>>15)&15, opc2=(INSWORD>>10)&3;
	if(!(opc&12) && !opc2) UNALLOCATED(ENC_UNALLOCATED_713_MORTLACH_EXPAND_2DST_NCTG);
	...
	if(opc2) UNALLOCATED(ENC_UNALLOCATED_712_MORTLACH_EXPAND_2DST_NCTG);
	UNMATCHED;
}
...
{
	uint32_t opc=(INSWORD>>16)&7, opc2=(INSWORD>>10)&3;
	if(!(opc&6) && !opc2) UNALLOCATED(ENC_UNALLOCATED_715_MORTLACH_EXPAND_4DST_NCTG);
	...
	if(opc2) UNALLOCATED(ENC_UNALLOCATED_714_MORTLACH_EXPAND_4DST_NCTG);
	UNMATCHED;
}
...
int decode_iclass_mortlach_expand_4dst2src_nctg(context *ctx, Instruction *dec)
{
	...
	if(opc) UNALLOCATED(ENC_UNALLOCATED_716_MORTLACH_EXPAND_4DST2SRC_NCTG);
	UNMATCHED;
}
...
int decode_iclass_mortlach_extract_zt(context *ctx, Instruction *dec)
{
	...
	if(opc!=0x1f) UNALLOCATED(ENC_UNALLOCATED_717_MORTLACH_EXTRACT_ZT);
	UNMATCHED;
}
...
int decode_iclass_mortlach_insert_zt(context *ctx, Instruction *dec)
{
	...
	if(opc!=0x1f) UNALLOCATED(ENC_UNALLOCATED_718_MORTLACH_INSERT_ZT);
	UNMATCHED;
}
...
int decode_iclass_mortlach_move_to_zt(context *ctx, Instruction *dec)
{
	...
	if(opc!=0x1f) UNALLOCATED(ENC_UNALLOCATED_719_MORTLACH_MOVE_TO_ZT);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_mla_long_long_idx_s(context *ctx, Instruction *dec)
{
	...
	if(op && S) UNALLOCATED(ENC_UNALLOCATED_720_MORTLACH_MULTI4_MLA_LONG_LONG_IDX_S);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_zza_idx_s(context *ctx, Instruction *dec)
{
	...
	if(!op && opc2==3) UNALLOCATED(ENC_UNALLOCATED_721_MORTLACH_MULTI4_ZZA_IDX_S);
...
int decode_iclass_mortlach_multi4_zza_idx_d(context *ctx, Instruction *dec)
{
	...
	if(op && !(opc2&1)) UNALLOCATED(ENC_UNALLOCATED_722_MORTLACH_MULTI4_ZZA_IDX_D);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi1_mla_long_long_idx_s(context *ctx, Instruction *dec)
{
	...
	if(S && op) UNALLOCATED(ENC_UNALLOCATED_723_MORTLACH_MULTI1_MLA_LONG_LONG_IDX_S);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_mla_long_long_idx_s(context *ctx, Instruction *dec)
{
	...
	if(op && S) UNALLOCATED(ENC_UNALLOCATED_724_MORTLACH_MULTI2_MLA_LONG_LONG_IDX_S);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_zza_idx_s(context *ctx, Instruction *dec)
{
	...
	if(!op && opc2==5) UNALLOCATED(ENC_UNALLOCATED_725_MORTLACH_MULTI2_ZZA_IDX_S);
...
int decode_iclass_mortlach_multi4_zz_za_mla_long_long_mm(context *ctx, Instruction *dec)
{
	...
	if(!sz && !U && S && op) UNALLOCATED(ENC_UNALLOCATED_728_MORTLACH_MULTI4_ZZ_ZA_MLA_LONG_LONG_MM);
	...
	if(!sz && U && op) UNALLOCATED(ENC_UNALLOCATED_727_MORTLACH_MULTI4_ZZ_ZA_MLA_LONG_LONG_MM);
	if(sz && op) UNALLOCATED(ENC_UNALLOCATED_726_MORTLACH_MULTI4_ZZ_ZA_MLA_LONG_LONG_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_zz_za_mla_long_long_mm(context *ctx, Instruction *dec)
{
	...
	if(!sz && !U && S && op) UNALLOCATED(ENC_UNALLOCATED_731_MORTLACH_MULTI2_ZZ_ZA_MLA_LONG_LONG_MM);
	...
	if(!sz && U && op) UNALLOCATED(ENC_UNALLOCATED_730_MORTLACH_MULTI2_ZZ_ZA_MLA_LONG_LONG_MM);
	if(sz && op) UNALLOCATED(ENC_UNALLOCATED_729_MORTLACH_MULTI2_ZZ_ZA_MLA_LONG_LONG_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_z_z_minmax_mm(context *ctx, Instruction *dec)
{
	...
	if((opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_732_MORTLACH_MULTI4_Z_Z_MINMAX_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_z_z_fminmax_mm(context *ctx, Instruction *dec)
{
	...
	if(opc==3) UNALLOCATED(ENC_UNALLOCATED_733_MORTLACH_MULTI4_Z_Z_FMINMAX_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_z_z_fscale_mm(context *ctx, Instruction *dec)
{
	...
	if(!opc && o2) UNALLOCATED(ENC_UNALLOCATED_735_MORTLACH_MULTI4_Z_Z_FSCALE_MM);
	if(opc) UNALLOCATED(ENC_UNALLOCATED_734_MORTLACH_MULTI4_Z_Z_FSCALE_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_z_z_shift_mm(context *ctx, Instruction *dec)
{
	...
	if(opc!=1) UNALLOCATED(ENC_UNALLOCATED_736_MORTLACH_MULTI4_Z_Z_SHIFT_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_z_z_minmax_mm(context *ctx, Instruction *dec)
{
	...
	if((opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_737_MORTLACH_MULTI2_Z_Z_MINMAX_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_z_z_fminmax_mm(context *ctx, Instruction *dec)
{
	...
	if(opc==3) UNALLOCATED(ENC_UNALLOCATED_738_MORTLACH_MULTI2_Z_Z_FMINMAX_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_z_z_fscale_mm(context *ctx, Instruction *dec)
{
	...
	if(!opc && o2) UNALLOCATED(ENC_UNALLOCATED_740_MORTLACH_MULTI2_Z_Z_FSCALE_MM);
	if(opc) UNALLOCATED(ENC_UNALLOCATED_739_MORTLACH_MULTI2_Z_Z_FSCALE_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_z_z_shift_mm(context *ctx, Instruction *dec)
{
	...
	if(opc!=1) UNALLOCATED(ENC_UNALLOCATED_741_MORTLACH_MULTI2_Z_Z_SHIFT_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_z_z_sqdmulh_mm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_742_MORTLACH_MULTI4_Z_Z_SQDMULH_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_z_z_sqdmulh_mm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_743_MORTLACH_MULTI2_Z_Z_SQDMULH_MM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_zz_za_mla_long_long_sm(context *ctx, Instruction *dec)
{
	...
	if(!sz && S && op) UNALLOCATED(ENC_UNALLOCATED_745_MORTLACH_MULTI4_ZZ_ZA_MLA_LONG_LONG_SM);
	if(sz && op) UNALLOCATED(ENC_UNALLOCATED_744_MORTLACH_MULTI4_ZZ_ZA_MLA_LONG_LONG_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_zz_za_fma_long_sm(context *ctx, Instruction *dec)
{
	...
	if(!op && S && o2) UNALLOCATED(ENC_UNALLOCATED_747_MORTLACH_MULTI4_ZZ_ZA_FMA_LONG_SM);
	...
	if(op && o2) UNALLOCATED(ENC_UNALLOCATED_746_MORTLACH_MULTI4_ZZ_ZA_FMA_LONG_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_zz_za_mla_long_sm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_748_MORTLACH_MULTI4_ZZ_ZA_MLA_LONG_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_zz_za_mla_long_long_sm(context *ctx, Instruction *dec)
{
	...
	if(!sz && S && op) UNALLOCATED(ENC_UNALLOCATED_750_MORTLACH_MULTI2_ZZ_ZA_MLA_LONG_LONG_SM);
	if(sz && op) UNALLOCATED(ENC_UNALLOCATED_749_MORTLACH_MULTI2_ZZ_ZA_MLA_LONG_LONG_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi1_zz_za_mla_long_long_sm(context *ctx, Instruction *dec)
{
	...
	if(!sz && !U && S && op) UNALLOCATED(ENC_UNALLOCATED_753_MORTLACH_MULTI1_ZZ_ZA_MLA_LONG_LONG_SM);
	...
	if(!sz && U && op) UNALLOCATED(ENC_UNALLOCATED_752_MORTLACH_MULTI1_ZZ_ZA_MLA_LONG_LONG_SM);
	if(sz && op) UNALLOCATED(ENC_UNALLOCATED_751_MORTLACH_MULTI1_ZZ_ZA_MLA_LONG_LONG_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_zz_za_fma_long_sm(context *ctx, Instruction *dec)
{
	...
	if(!op && S && o2) UNALLOCATED(ENC_UNALLOCATED_755_MORTLACH_MULTI2_ZZ_ZA_FMA_LONG_SM);
	...
	if(op && o2) UNALLOCATED(ENC_UNALLOCATED_754_MORTLACH_MULTI2_ZZ_ZA_FMA_LONG_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_zz_za_mla_long_sm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_756_MORTLACH_MULTI2_ZZ_ZA_MLA_LONG_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_z_z_fscale_sm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_757_MORTLACH_MULTI4_Z_Z_FSCALE_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_z_z_shift_sm(context *ctx, Instruction *dec)
{
	...
	if(opc!=1) UNALLOCATED(ENC_UNALLOCATED_758_MORTLACH_MULTI4_Z_Z_SHIFT_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_z_z_add_sm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_759_MORTLACH_MULTI4_Z_Z_ADD_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_z_z_sqdmulh_sm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_760_MORTLACH_MULTI4_Z_Z_SQDMULH_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_z_z_fscale_sm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_761_MORTLACH_MULTI2_Z_Z_FSCALE_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_z_z_shift_sm(context *ctx, Instruction *dec)
{
	...
	if(opc!=1) UNALLOCATED(ENC_UNALLOCATED_762_MORTLACH_MULTI2_Z_Z_SHIFT_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_z_z_add_sm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_763_MORTLACH_MULTI2_Z_Z_ADD_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_z_z_sqdmulh_sm(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_764_MORTLACH_MULTI2_Z_Z_SQDMULH_SM);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_fclamp(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_765_MORTLACH_MULTI2_FCLAMP);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_fclamp(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_766_MORTLACH_MULTI4_FCLAMP);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_qrshr(context *ctx, Instruction *dec)
{
	...
	if(op && U) UNALLOCATED(ENC_UNALLOCATED_767_MORTLACH_MULTI2_QRSHR);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_qrshr(context *ctx, Instruction *dec)
{
	...
	if(op && U) UNALLOCATED(ENC_UNALLOCATED_768_MORTLACH_MULTI4_QRSHR);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_narrow_int_cvrt(context *ctx, Instruction *dec)
{
	...
	if(op && U) UNALLOCATED(ENC_UNALLOCATED_769_MORTLACH_MULTI2_NARROW_INT_CVRT);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi2_frint(context *ctx, Instruction *dec)
{
	...
	if(size==2 && opc==3) UNALLOCATED(ENC_UNALLOCATED_773_MORTLACH_MULTI2_FRINT);
	if(size==2 && opc==4 && HasSME2()) return frinta_mz_z(ctx, dec); // -> frinta_mz_z_2
	if(size==2 && opc==5) UNALLOCATED(ENC_UNALLOCATED_772_MORTLACH_MULTI2_FRINT);
	if(size==2 && (opc&6)==6) UNALLOCATED(ENC_UNALLOCATED_771_MORTLACH_MULTI2_FRINT);
	if(size!=2) UNALLOCATED(ENC_UNALLOCATED_770_MORTLACH_MULTI2_FRINT);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_narrow_int_cvrt(context *ctx, Instruction *dec)
{
	...
	if(op && U) UNALLOCATED(ENC_UNALLOCATED_774_MORTLACH_MULTI4_NARROW_INT_CVRT);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi4_frint(context *ctx, Instruction *dec)
{
	...
	if(size==2 && opc==3) UNALLOCATED(ENC_UNALLOCATED_778_MORTLACH_MULTI4_FRINT);
	if(size==2 && opc==4 && HasSME2()) return frinta_mz_z(ctx, dec); // -> frinta_mz_z_4
	if(size==2 && opc==5) UNALLOCATED(ENC_UNALLOCATED_777_MORTLACH_MULTI4_FRINT);
	if(size==2 && (opc&6)==6) UNALLOCATED(ENC_UNALLOCATED_776_MORTLACH_MULTI4_FRINT);
	if(size!=2) UNALLOCATED(ENC_UNALLOCATED_775_MORTLACH_MULTI4_FRINT);
	UNMATCHED;
}
...
int decode_iclass_mortlach_multi_zero(context *ctx, Instruction *dec)
{
	...
	if(opc==5 && (opc2&4)==4) UNALLOCATED(ENC_UNALLOCATED_781_MORTLACH_MULTI_ZERO);
	if((opc&6)==6 && (opc2&6)==2) UNALLOCATED(ENC_UNALLOCATED_780_MORTLACH_MULTI_ZERO);
	...
	if((opc&2)==2 && (opc2&4)==4) UNALLOCATED(ENC_UNALLOCATED_779_MORTLACH_MULTI_ZERO);
	UNMATCHED;
}
...
{
	uint32_t opc=INSWORD&15;
	if(opc==1 && HasSME2()) return zero_zt_i(ctx, dec); // -> zero_zt_i_
	if(opc!=1) UNALLOCATED(ENC_UNALLOCATED_782_MORTLACH_ZERO_ZT);
	UNMATCHED;
}
...
int decode_iclass_sve_int_bin_cons_misc_0_c(context *ctx, Instruction *dec)
{
	...
	if(!opc && HasSVE() && HasSME2p2()) return fexpa_z_z(ctx, dec); // -> fexpa_z_z_
...
int decode_iclass_sve_intx_dot(context *ctx, Instruction *dec)
{
	...
	if(!U && HasSVE() && HasSME()) return sdot_z_zzz(ctx, dec); // -> sdot_z_zzz_
	if(U && HasSVE() && HasSME()) return udot_z_zzz(ctx, dec); // -> udot_z_zzz_
	UNMATCHED;
}
...
int decode_iclass_sve_intx_mixed_dot(context *ctx, Instruction *dec)
{
	...
	if(size!=2) UNALLOCATED(ENC_UNALLOCATED_513_SVE_INTX_MIXED_DOT);
	UNMATCHED;
}
...
int decode_iclass_sve_int_reduce_0(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_514_SVE_INT_REDUCE_0);
	UNMATCHED;
}
...
{
	uint32_t op=(INSWORD>>17)&1, U=(INSWORD>>16)&1;
	if(!op && !U) UNALLOCATED(ENC_UNALLOCATED_516_SVE_INT_REDUCE_0Q);
	if(!op && U && HasSVE2p1() && HasSME2p1()) return addqv_z_p_z(ctx, dec); // -> addqv_z_p_z_
	if(op) UNALLOCATED(ENC_UNALLOCATED_515_SVE_INT_REDUCE_0Q);
	UNMATCHED;
}
...
int decode_iclass_sve_int_movprfx_pred(context *ctx, Instruction *dec)
{
	...
	if(opc) UNALLOCATED(ENC_UNALLOCATED_517_SVE_INT_MOVPRFX_PRED);
	UNMATCHED;
}
...
int decode_iclass_sve_int_reduce_2(context *ctx, Instruction *dec)
{
	...
	if(opc==3) UNALLOCATED(ENC_UNALLOCATED_518_SVE_INT_REDUCE_2);
	UNMATCHED;
}
...
int decode_iclass_sve_int_reduce_2q(context *ctx, Instruction *dec)
{
	...
	if(opc==3) UNALLOCATED(ENC_UNALLOCATED_519_SVE_INT_REDUCE_2Q);
	UNMATCHED;
}
...
int decode_iclass_sve_int_un_pred_arit_1(context *ctx, Instruction *dec)
{
	...
	if(opc==7) UNALLOCATED(ENC_UNALLOCATED_520_SVE_INT_UN_PRED_ARIT_1);
	UNMATCHED;
}
...
int decode_iclass_sve_int_arith_imm0(context *ctx, Instruction *dec)
{
	...
	if(opc==2) UNALLOCATED(ENC_UNALLOCATED_521_SVE_INT_ARITH_IMM0);
...
int decode_iclass_sve_int_arith_imm1(context *ctx, Instruction *dec)
{
	...
	if(!(opc&4) && o2) UNALLOCATED(ENC_UNALLOCATED_523_SVE_INT_ARITH_IMM1);
	if((opc&4)==4) UNALLOCATED(ENC_UNALLOCATED_522_SVE_INT_ARITH_IMM1);
	UNMATCHED;
}
...
int decode_iclass_sve_int_arith_imm2(context *ctx, Instruction *dec)
{
	...
	if(!opc && o2) UNALLOCATED(ENC_UNALLOCATED_525_SVE_INT_ARITH_IMM2);
	if(opc) UNALLOCATED(ENC_UNALLOCATED_524_SVE_INT_ARITH_IMM2);
	UNMATCHED;
}
...
int decode_iclass_sve_int_dup_imm(context *ctx, Instruction *dec)
{
	...
	if(opc) UNALLOCATED(ENC_UNALLOCATED_526_SVE_INT_DUP_IMM);
	UNMATCHED;
}
...
int decode_iclass_sve_int_dup_fpimm(context *ctx, Instruction *dec)
{
	...
	if(!opc && o2) UNALLOCATED(ENC_UNALLOCATED_528_SVE_INT_DUP_FPIMM);
	if(opc) UNALLOCATED(ENC_UNALLOCATED_527_SVE_INT_DUP_FPIMM);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_32b_gld_vs(context *ctx, Instruction *dec)
{
	...
	if(opc==2 && !U) UNALLOCATED(ENC_UNALLOCATED_529_SVE_MEM_32B_GLD_VS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_32b_gld_sv_b(context *ctx, Instruction *dec)
{
	...
	if(!U) UNALLOCATED(ENC_UNALLOCATED_530_SVE_MEM_32B_GLD_SV_B);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_32b_gldnt_vs(context *ctx, Instruction *dec)
{
	...
	if(msz==2 && !U) UNALLOCATED(ENC_UNALLOCATED_532_SVE_MEM_32B_GLDNT_VS);
	if(msz==2 && U && HasSVE2()) return ldnt1w_z_p_ar(ctx, dec); // -> ldnt1w_z_p_ar_s_x32_unscaled
	if(msz==3) UNALLOCATED(ENC_UNALLOCATED_531_SVE_MEM_32B_GLDNT_VS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_prfm_ss(context *ctx, Instruction *dec)
{
	...
	if(Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_533_SVE_MEM_PRFM_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_32b_gld_vi(context *ctx, Instruction *dec)
{
	...
	if(msz==2 && !U) UNALLOCATED(ENC_UNALLOCATED_535_SVE_MEM_32B_GLD_VI);
	if(msz==3) UNALLOCATED(ENC_UNALLOCATED_534_SVE_MEM_32B_GLD_VI);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_64b_gld_vs(context *ctx, Instruction *dec)
{
	...
	if(msz==3 && !U) UNALLOCATED(ENC_UNALLOCATED_536_SVE_MEM_64B_GLD_VS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_64b_gld_sv(context *ctx, Instruction *dec)
{
	...
	if(opc==3 && !U) UNALLOCATED(ENC_UNALLOCATED_537_SVE_MEM_64B_GLD_SV);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_64b_gldnt_vs(context *ctx, Instruction *dec)
{
	...
	if(msz==3 && !U) UNALLOCATED(ENC_UNALLOCATED_538_SVE_MEM_64B_GLDNT_VS);
...
int decode_iclass_sve_mem_64b_gld_vi(context *ctx, Instruction *dec)
{
	...
	if(msz==3 && !U) UNALLOCATED(ENC_UNALLOCATED_539_SVE_MEM_64B_GLD_VI);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_64b_gld_vs2(context *ctx, Instruction *dec)
{
	...
	if(msz==3 && !U) UNALLOCATED(ENC_UNALLOCATED_540_SVE_MEM_64B_GLD_VS2);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_64b_gld_sv2(context *ctx, Instruction *dec)
{
	...
	if(opc==3 && !U) UNALLOCATED(ENC_UNALLOCATED_541_SVE_MEM_64B_GLD_SV2);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_ldqr_ss(context *ctx, Instruction *dec)
{
	...
	if(!(ssz&2) && Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_543_SVE_MEM_LDQR_SS);
	if((ssz&2)==2) UNALLOCATED(ENC_UNALLOCATED_542_SVE_MEM_LDQR_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_ldqr_si(context *ctx, Instruction *dec)
{
	...
	if((ssz&2)==2) UNALLOCATED(ENC_UNALLOCATED_544_SVE_MEM_LDQR_SI);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_cld_si_q(context *ctx, Instruction *dec)
{
	...
	if(!(dtype&2)) UNALLOCATED(ENC_UNALLOCATED_545_SVE_MEM_CLD_SI_Q);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_cld_ss(context *ctx, Instruction *dec)
{
	...
	if(Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_546_SVE_MEM_CLD_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_cld_ss_q(context *ctx, Instruction *dec)
{
	...
	if((dtype&2)==2 && Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_548_SVE_MEM_CLD_SS_Q);
	if(!(dtype&2)) UNALLOCATED(ENC_UNALLOCATED_547_SVE_MEM_CLD_SS_Q);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_eldq_ss(context *ctx, Instruction *dec)
{
	...
	if(num && Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_550_SVE_MEM_ELDQ_SS);
	if(!num) UNALLOCATED(ENC_UNALLOCATED_549_SVE_MEM_ELDQ_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_cldnt_ss(context *ctx, Instruction *dec)
{
	...
	if(Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_551_SVE_MEM_CLDNT_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_eld_ss(context *ctx, Instruction *dec)
{
	...
	if(opc && Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_552_SVE_MEM_ELD_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_eldq_si(context *ctx, Instruction *dec)
{
	...
	if(!num) UNALLOCATED(ENC_UNALLOCATED_553_SVE_MEM_ELDQ_SI);
...
int decode_iclass_sve_mem_estq_si(context *ctx, Instruction *dec)
{
	...
	if(!num) UNALLOCATED(ENC_UNALLOCATED_554_SVE_MEM_ESTQ_SI);
...
int decode_iclass_sve_mem_estq_ss(context *ctx, Instruction *dec)
{
	...
	if(num && Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_556_SVE_MEM_ESTQ_SS);
	if(!num) UNALLOCATED(ENC_UNALLOCATED_555_SVE_MEM_ESTQ_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_cst_ss(context *ctx, Instruction *dec)
{
	...
	if(opc==4 && !o2 && Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_560_SVE_MEM_CST_SS);
	...
	if(!(opc&5) && Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_559_SVE_MEM_CST_SS);
	...
	if(opc&1 && Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_558_SVE_MEM_CST_SS);
	if(opc==4 && o2) UNALLOCATED(ENC_UNALLOCATED_557_SVE_MEM_CST_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_cst_si(context *ctx, Instruction *dec)
{
	...
	if(msz==2 && opc==1) UNALLOCATED(ENC_UNALLOCATED_562_SVE_MEM_CST_SI);
	...
	if(msz==3 && !(opc&2)) UNALLOCATED(ENC_UNALLOCATED_561_SVE_MEM_CST_SI);
...
int decode_iclass_sve_mem_cstnt_ss(context *ctx, Instruction *dec)
{
	...
	if(Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_563_SVE_MEM_CSTNT_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_est_ss(context *ctx, Instruction *dec)
{
	...
	if(opc && Rm==0x1f) UNALLOCATED(ENC_UNALLOCATED_564_SVE_MEM_EST_SS);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_sstnt_32b_vs(context *ctx, Instruction *dec)
{
	...
	if(msz==3) UNALLOCATED(ENC_UNALLOCATED_565_SVE_MEM_SSTNT_32B_VS);
	UNMATCHED;
}
...
{
	uint32_t msz=(INSWORD>>23)&3;
	if(!msz) UNALLOCATED(ENC_UNALLOCATED_566_SVE_MEM_SST_SV2);
...
int decode_iclass_sve_mem_sst_vi_b(context *ctx, Instruction *dec)
{
	...
	if(msz==3) UNALLOCATED(ENC_UNALLOCATED_567_SVE_MEM_SST_VI_B);
	UNMATCHED;
}
...
int decode_iclass_sve_mem_sst_vs_b(context *ctx, Instruction *dec)
{
	...
	if(msz==3) UNALLOCATED(ENC_UNALLOCATED_568_SVE_MEM_SST_VS_B);
	UNMATCHED;
}
...
{
	uint32_t msz=(INSWORD>>23)&3;
	if(!msz) UNALLOCATED(ENC_UNALLOCATED_569_SVE_MEM_SST_SV_A);
...
{
	uint32_t msz=(INSWORD>>23)&3;
	if(!msz) UNALLOCATED(ENC_UNALLOCATED_570_SVE_MEM_SST_SV_B);
	...
	if(msz==3) UNALLOCATED(ENC_UNALLOCATED_571_SVE_MEM_SST_SV_B);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_clong(context *ctx, Instruction *dec)
{
	...
	if(!S && tb) UNALLOCATED(ENC_UNALLOCATED_572_SVE_INTX_CLONG);
...
int decode_iclass_sve_intx_mmla(context *ctx, Instruction *dec)
{
	...
	if(uns==1) UNALLOCATED(ENC_UNALLOCATED_573_SVE_INTX_MMLA);
...
int decode_iclass_sve_intx_perm_bit(context *ctx, Instruction *dec)
{
	...
	if(opc==3) UNALLOCATED(ENC_UNALLOCATED_574_SVE_INTX_PERM_BIT);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_dot_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_575_SVE_INTX_DOT_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_mixed_dot_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(size!=2) UNALLOCATED(ENC_UNALLOCATED_576_SVE_INTX_MIXED_DOT_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_qdmla_long_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_577_SVE_INTX_QDMLA_LONG_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_cdot_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_578_SVE_INTX_CDOT_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_cmla_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_579_SVE_INTX_CMLA_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_qrdcmla_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_580_SVE_INTX_QRDCMLA_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_mla_long_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_581_SVE_INTX_MLA_LONG_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_mul_long_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_582_SVE_INTX_MUL_LONG_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_qdmul_long_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_583_SVE_INTX_QDMUL_LONG_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_int_break(context *ctx, Instruction *dec)
{
	...
	if(S && M) UNALLOCATED(ENC_UNALLOCATED_584_SVE_INT_BREAK);
...
int decode_iclass_sve_int_perm_bin_perm_pp(context *ctx, Instruction *dec)
{
	...
	if(opc==3) UNALLOCATED(ENC_UNALLOCATED_585_SVE_INT_PERM_BIN_PERM_PP);
	UNMATCHED;
}
...
int decode_iclass_sve_int_perm_bin_perm_zz(context *ctx, Instruction *dec)
{
	...
	if((opc&6)==6) UNALLOCATED(ENC_UNALLOCATED_586_SVE_INT_PERM_BIN_PERM_ZZ);
	UNMATCHED;
}
...
int decode_iclass_sve_int_perm_revd(context *ctx, Instruction *dec)
{
	...
	if(size) UNALLOCATED(ENC_UNALLOCATED_587_SVE_INT_PERM_REVD);
	UNMATCHED;
}
...
int decode_iclass_sve_int_perm_bin_long_perm_zz(context *ctx, Instruction *dec)
{
	...
	if(opc==2) UNALLOCATED(ENC_UNALLOCATED_588_SVE_INT_PERM_BIN_LONG_PERM_ZZ);
	UNMATCHED;
}
...
int decode_iclass_sve_int_perm_binquads(context *ctx, Instruction *dec)
{
	...
	if(opc==7) UNALLOCATED(ENC_UNALLOCATED_590_SVE_INT_PERM_BINQUADS);
	if((opc&6)==4) UNALLOCATED(ENC_UNALLOCATED_589_SVE_INT_PERM_BINQUADS);
	UNMATCHED;
}
...
int decode_iclass_sve_int_mov_v2p(context *ctx, Instruction *dec)
{
	...
	if(!opc && !opc2) UNALLOCATED(ENC_UNALLOCATED_591_SVE_INT_MOV_V2P);
...
{
	uint32_t opc=(INSWORD>>22)&3, opc2=(INSWORD>>17)&3;
	if(!opc && !opc2) UNALLOCATED(ENC_UNALLOCATED_592_SVE_INT_MOV_P2V);
...
int decode_iclass_sve_int_pcount_pred(context *ctx, Instruction *dec)
{
	...
	if(opc==3) UNALLOCATED(ENC_UNALLOCATED_594_SVE_INT_PCOUNT_PRED);
	if((opc&4)==4) UNALLOCATED(ENC_UNALLOCATED_593_SVE_INT_PCOUNT_PRED);
	UNMATCHED;
}
...
int decode_iclass_sve_int_pcount_pn(context *ctx, Instruction *dec)
{
	...
	if(opc) UNALLOCATED(ENC_UNALLOCATED_595_SVE_INT_PCOUNT_PN);
	UNMATCHED;
}
...
int decode_iclass_sve_int_pred_log(context *ctx, Instruction *dec)
{
	...
	if(!op && S && o2 && o3) UNALLOCATED(ENC_UNALLOCATED_596_SVE_INT_PRED_LOG);
...
int decode_iclass_sve_int_ptest(context *ctx, Instruction *dec)
{
	...
	if(!op && S && opc2) UNALLOCATED(ENC_UNALLOCATED_599_SVE_INT_PTEST);
	if(!op && !S) UNALLOCATED(ENC_UNALLOCATED_598_SVE_INT_PTEST);
	if(op) UNALLOCATED(ENC_UNALLOCATED_597_SVE_INT_PTEST);
	UNMATCHED;
}
...
int decode_iclass_sve_int_pfirst(context *ctx, Instruction *dec)
{
	...
	if(!op && !S) UNALLOCATED(ENC_UNALLOCATED_601_SVE_INT_PFIRST);
	if(!op && S && HasSVE() && HasSME()) return pfirst_p_p_p(ctx, dec); // -> pfirst_p_p_p_
	if(op) UNALLOCATED(ENC_UNALLOCATED_600_SVE_INT_PFIRST);
	UNMATCHED;
}
...
int decode_iclass_sve_int_pfalse(context *ctx, Instruction *dec)
{
	...
	if(!op && S) UNALLOCATED(ENC_UNALLOCATED_603_SVE_INT_PFALSE);
	if(op) UNALLOCATED(ENC_UNALLOCATED_602_SVE_INT_PFALSE);
	UNMATCHED;
}
...
int decode_iclass_sve_int_rdffr(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_604_SVE_INT_RDFFR);
	UNMATCHED;
}
...
int decode_iclass_sve_int_rdffr_2(context *ctx, Instruction *dec)
{
	...
	if(!op && S) UNALLOCATED(ENC_UNALLOCATED_606_SVE_INT_RDFFR_2);
	if(op) UNALLOCATED(ENC_UNALLOCATED_605_SVE_INT_RDFFR_2);
	UNMATCHED;
}
...
int decode_iclass_sve_int_pred_dup(context *ctx, Instruction *dec)
{
	...
	if(S) UNALLOCATED(ENC_UNALLOCATED_607_SVE_INT_PRED_DUP);
	UNMATCHED;
}
...
int decode_iclass_sve_int_brkp(context *ctx, Instruction *dec)
{
	...
	if(op) UNALLOCATED(ENC_UNALLOCATED_608_SVE_INT_BRKP);
	UNMATCHED;
}
...
int decode_iclass_sve_int_ctr_to_mask(context *ctx, Instruction *dec)
{
	...
	if((opc&6)==6) UNALLOCATED(ENC_UNALLOCATED_609_SVE_INT_CTR_TO_MASK);
...
int decode_iclass_sve_int_read_vl_a(context *ctx, Instruction *dec)
{
	...
	if(!op && opc2!=0x1f) UNALLOCATED(ENC_UNALLOCATED_611_SVE_INT_READ_VL_A);
	if(op) UNALLOCATED(ENC_UNALLOCATED_610_SVE_INT_READ_VL_A);
	UNMATCHED;
}
...
int decode_iclass_sve_int_read_svl_a(context *ctx, Instruction *dec)
{
	...
	if(!op && opc2!=0x1f) UNALLOCATED(ENC_UNALLOCATED_613_SVE_INT_READ_SVL_A);
	if(op) UNALLOCATED(ENC_UNALLOCATED_612_SVE_INT_READ_SVL_A);
	UNMATCHED;
}
...
int decode_iclass_sve_int_wrffr(context *ctx, Instruction *dec)
{
	...
	if(opc) UNALLOCATED(ENC_UNALLOCATED_614_SVE_INT_WRFFR);
	UNMATCHED;
}
...
int decode_iclass_sve_int_setffr(context *ctx, Instruction *dec)
{
	...
	if(opc) UNALLOCATED(ENC_UNALLOCATED_615_SVE_INT_SETFFR);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_2op_p_vd(context *ctx, Instruction *dec)
{
	...
	if(opc) UNALLOCATED(ENC_UNALLOCATED_616_SVE_FP_2OP_P_VD);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_2op_p_zds(context *ctx, Instruction *dec)
{
	...
	if(opc==11) UNALLOCATED(ENC_UNALLOCATED_617_SVE_FP_2OP_P_ZDS);
...
int decode_iclass_sve_fp_3op_u_zd(context *ctx, Instruction *dec)
{
	...
	if((opc&6)==4) UNALLOCATED(ENC_UNALLOCATED_618_SVE_FP_3OP_U_ZD);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_3op_p_pd(context *ctx, Instruction *dec)
{
	...
	if(op && o2 && !o3) UNALLOCATED(ENC_UNALLOCATED_619_SVE_FP_3OP_P_PD);
...
int decode_iclass_sve_fp_2op_p_pd(context *ctx, Instruction *dec)
{
	...
	if(eq && ne) UNALLOCATED(ENC_UNALLOCATED_620_SVE_FP_2OP_P_PD);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_fcmla_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!(size&2)) UNALLOCATED(ENC_UNALLOCATED_621_SVE_FP_FCMLA_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_fcvt2z(context *ctx, Instruction *dec)
{
	...
	if(!(opc&1) && opc2==3) UNALLOCATED(ENC_UNALLOCATED_625_SVE_FP_FCVT2Z);
	if(!opc && !(opc2&2)) UNALLOCATED(ENC_UNALLOCATED_623_SVE_FP_FCVT2Z);
	if(opc==3 && !(opc2&2)) UNALLOCATED(ENC_UNALLOCATED_624_SVE_FP_FCVT2Z);
	if(opc==1) UNALLOCATED(ENC_UNALLOCATED_622_SVE_FP_FCVT2Z);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_fcvt2(context *ctx, Instruction *dec)
{
	...
	if(!(opc&1) && opc2==3) UNALLOCATED(ENC_UNALLOCATED_629_SVE_FP_FCVT2);
	if(!opc && !(opc2&2)) UNALLOCATED(ENC_UNALLOCATED_627_SVE_FP_FCVT2);
	if(opc==3 && !(opc2&2)) UNALLOCATED(ENC_UNALLOCATED_628_SVE_FP_FCVT2);
	if(opc==1) UNALLOCATED(ENC_UNALLOCATED_626_SVE_FP_FCVT2);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_fast_red(context *ctx, Instruction *dec)
{
	...
	if(opc==1) UNALLOCATED(ENC_UNALLOCATED_631_SVE_FP_FAST_RED);
	...
	if((opc&6)==2) UNALLOCATED(ENC_UNALLOCATED_630_SVE_FP_FAST_RED);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_fast_redq(context *ctx, Instruction *dec)
{
	...
	if(opc==1) UNALLOCATED(ENC_UNALLOCATED_633_SVE_FP_FAST_REDQ);
	...
	if((opc&6)==2) UNALLOCATED(ENC_UNALLOCATED_632_SVE_FP_FAST_REDQ);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_fmul_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if((size&2)==2 && o2) UNALLOCATED(ENC_UNALLOCATED_634_SVE_FP_FMUL_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_3op_p_zds_a(context *ctx, Instruction *dec)
{
	...
	if(!size && (opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_635_SVE_FP_3OP_P_ZDS_A);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_fma_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if((size&2)==2 && o2) UNALLOCATED(ENC_UNALLOCATED_636_SVE_FP_FMA_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_2op_p_zd_a(context *ctx, Instruction *dec)
{
	...
	if(opc==5) UNALLOCATED(ENC_UNALLOCATED_637_SVE_FP_2OP_P_ZD_A);
...
int decode_iclass_sve_fp_2op_p_zd_b_0(context *ctx, Instruction *dec)
{
	...
	if(!(opc&1) && opc2==3) UNALLOCATED(ENC_UNALLOCATED_640_SVE_FP_2OP_P_ZD_B_0);
	if(!opc && !(opc2&2)) UNALLOCATED(ENC_UNALLOCATED_639_SVE_FP_2OP_P_ZD_B_0);
	if(opc==1) UNALLOCATED(ENC_UNALLOCATED_638_SVE_FP_2OP_P_ZD_B_0);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_2op_p_zd_b_1(context *ctx, Instruction *dec)
{
	...
	if((opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_641_SVE_FP_2OP_P_ZD_B_1);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_2op_p_zd_c(context *ctx, Instruction *dec)
{
	...
	if(opc==1 && !opc2) UNALLOCATED(ENC_UNALLOCATED_644_SVE_FP_2OP_P_ZD_C);
	if(opc==2 && opc2!=2) UNALLOCATED(ENC_UNALLOCATED_642_SVE_FP_2OP_P_ZD_C);
	if(opc==3 && opc2==1) UNALLOCATED(ENC_UNALLOCATED_643_SVE_FP_2OP_P_ZD_C);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_2op_p_zd_d(context *ctx, Instruction *dec)
{
	...
	if(opc==1 && !opc2) UNALLOCATED(ENC_UNALLOCATED_648_SVE_FP_2OP_P_ZD_D);
	if(opc==2 && opc2!=2) UNALLOCATED(ENC_UNALLOCATED_646_SVE_FP_2OP_P_ZD_D);
	if(opc==3 && opc2==1) UNALLOCATED(ENC_UNALLOCATED_647_SVE_FP_2OP_P_ZD_D);
	if(!opc && !U && HasSVE2() && HasSME()) return flogb_z_p_z(ctx, dec); // -> flogb_z_p_z_m
	if(!opc && U) UNALLOCATED(ENC_UNALLOCATED_645_SVE_FP_2OP_P_ZD_D);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_fdot_by_indexed_elem(context *ctx, Instruction *dec)
{
	...
	if(!op && opc2==2) UNALLOCATED(ENC_UNALLOCATED_650_SVE_FP_FDOT_BY_INDEXED_ELEM);
	...
	if(op && (opc2&2)==2) UNALLOCATED(ENC_UNALLOCATED_649_SVE_FP_FDOT_BY_INDEXED_ELEM);
	UNMATCHED;
}
...
int decode_iclass_sve_crypto_unary(context *ctx, Instruction *dec)
{
	...
	if(size) UNALLOCATED(ENC_UNALLOCATED_651_SVE_CRYPTO_UNARY);
	UNMATCHED;
}
...
int decode_iclass_sve_crypto_binary_dest(context *ctx, Instruction *dec)
{
	...
	if(!size && op && o2) UNALLOCATED(ENC_UNALLOCATED_653_SVE_CRYPTO_BINARY_DEST);
	if(size) UNALLOCATED(ENC_UNALLOCATED_652_SVE_CRYPTO_BINARY_DEST);
	UNMATCHED;
}
...
int decode_iclass_sve_crypto_binary_multi2(context *ctx, Instruction *dec)
{
	...
	if(!size && o3) UNALLOCATED(ENC_UNALLOCATED_655_SVE_CRYPTO_BINARY_MULTI2);
	if(size) UNALLOCATED(ENC_UNALLOCATED_654_SVE_CRYPTO_BINARY_MULTI2);
	UNMATCHED;
}
...
int decode_iclass_sve_crypto_binary_multi4(context *ctx, Instruction *dec)
{
	...
	if(!size && opc3) UNALLOCATED(ENC_UNALLOCATED_657_SVE_CRYPTO_BINARY_MULTI4);
	if(size) UNALLOCATED(ENC_UNALLOCATED_656_SVE_CRYPTO_BINARY_MULTI4);
	UNMATCHED;
}
...
int decode_iclass_sve_crypto_binary_const(context *ctx, Instruction *dec)
{
	...
	if(size) UNALLOCATED(ENC_UNALLOCATED_658_SVE_CRYPTO_BINARY_CONST);
	UNMATCHED;
}
...
int decode_iclass_sve_crypto_pmull_multi(context *ctx, Instruction *dec)
{
	...
	if(size) UNALLOCATED(ENC_UNALLOCATED_659_SVE_CRYPTO_PMULL_MULTI);
	UNMATCHED;
}
...
int decode_iclass_sve_crypto_pmlal_multi(context *ctx, Instruction *dec)
{
	...
	if(size) UNALLOCATED(ENC_UNALLOCATED_660_SVE_CRYPTO_PMLAL_MULTI);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_bin_pred_shift_sat_round(context *ctx, Instruction *dec)
{
	...
	if(!Q && !N) UNALLOCATED(ENC_UNALLOCATED_661_SVE_INTX_BIN_PRED_SHIFT_SAT_ROUND);
	UNMATCHED;
}
...
{
	uint32_t opc=(INSWORD>>17)&3, U=(INSWORD>>16)&1;
	if(!opc && !U) UNALLOCATED(ENC_UNALLOCATED_663_SVE_INTX_ARITH_BINARY_PAIRS);
	...
	if(opc==1) UNALLOCATED(ENC_UNALLOCATED_662_SVE_INTX_ARITH_BINARY_PAIRS);
	UNMATCHED;
}
...
int decode_iclass_sve_int_mul_b(context *ctx, Instruction *dec)
{
	...
	if(size && opc==1) UNALLOCATED(ENC_UNALLOCATED_664_SVE_INT_MUL_B);
...
{
	uint32_t tszh=(INSWORD>>22)&1, tszl=(INSWORD>>20)&1, op=(INSWORD>>13)&1, U=(INSWORD>>12)&1, R=(INSWORD>>11)&1;
	if(!tszh && tszl && !op && !U && R && HasSME2() && HasSVE2p1()) return sqrshrun_z_mz2(ctx, dec); // -> sqrshrun_z_mz2_
	if(!tszh && tszl && !op && U && R) UNALLOCATED(ENC_UNALLOCATED_668_SVE_INTX_MULTI_SHIFT_NARROW);
	if(!tszh && tszl && op && !U && R && HasSME2() && HasSVE2p1()) return sqrshrn_z_mz2(ctx, dec); // -> sqrshrn_z_mz2_
	if(!tszh && tszl && op && U && R && HasSME2() && HasSVE2p1()) return uqrshrn_z_mz2(ctx, dec); // -> uqrshrn_z_mz2_
	if(!tszh && tszl && !R) UNALLOCATED(ENC_UNALLOCATED_667_SVE_INTX_MULTI_SHIFT_NARROW);
	if(!tszh && !tszl) UNALLOCATED(ENC_UNALLOCATED_666_SVE_INTX_MULTI_SHIFT_NARROW);
	if(tszh) UNALLOCATED(ENC_UNALLOCATED_665_SVE_INTX_MULTI_SHIFT_NARROW);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_extract_narrow(context *ctx, Instruction *dec)
{
	...
	if(opc==3) UNALLOCATED(ENC_UNALLOCATED_669_SVE_INTX_EXTRACT_NARROW);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_multi_extract_narrow(context *ctx, Instruction *dec)
{
	...
	if(!tszh && tszl==2 && opc==3) UNALLOCATED(ENC_UNALLOCATED_672_SVE_INTX_MULTI_EXTRACT_NARROW);
	if(!tszh && tszl!=2) UNALLOCATED(ENC_UNALLOCATED_671_SVE_INTX_MULTI_EXTRACT_NARROW);
	if(tszh) UNALLOCATED(ENC_UNALLOCATED_670_SVE_INTX_MULTI_EXTRACT_NARROW);
	UNMATCHED;
}
...
int decode_iclass_sve_intx_cons_arith_long(context *ctx, Instruction *dec)
{
	...
	if(op && !S) UNALLOCATED(ENC_UNALLOCATED_673_SVE_INTX_CONS_ARITH_LONG);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_pairwise(context *ctx, Instruction *dec)
{
	...
	if(opc==1) UNALLOCATED(ENC_UNALLOCATED_675_SVE_FP_PAIRWISE);
	...
	if((opc&6)==2) UNALLOCATED(ENC_UNALLOCATED_674_SVE_FP_PAIRWISE);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_z2op_p_zd_a(context *ctx, Instruction *dec)
{
	...
	if(op && opc2==1) UNALLOCATED(ENC_UNALLOCATED_676_SVE_FP_Z2OP_P_ZD_A);
...
int decode_iclass_sve_fp_z2op_p_zd_b_0(context *ctx, Instruction *dec)
{
	...
	if(!(opc&1) && opc2==3) UNALLOCATED(ENC_UNALLOCATED_679_SVE_FP_Z2OP_P_ZD_B_0);
	if(!opc && !(opc2&2)) UNALLOCATED(ENC_UNALLOCATED_678_SVE_FP_Z2OP_P_ZD_B_0);
	if(opc==1) UNALLOCATED(ENC_UNALLOCATED_677_SVE_FP_Z2OP_P_ZD_B_0);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_z2op_p_zd_b_1(context *ctx, Instruction *dec)
{
	...
	if((opc&2)==2) UNALLOCATED(ENC_UNALLOCATED_680_SVE_FP_Z2OP_P_ZD_B_1);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_z2op_p_zd_c(context *ctx, Instruction *dec)
{
	...
	if(opc==1 && !o2 && !o3) UNALLOCATED(ENC_UNALLOCATED_684_SVE_FP_Z2OP_P_ZD_C);
	if(opc==2 && o2 && o3) UNALLOCATED(ENC_UNALLOCATED_682_SVE_FP_Z2OP_P_ZD_C);
	if(opc==3 && !o2 && o3) UNALLOCATED(ENC_UNALLOCATED_683_SVE_FP_Z2OP_P_ZD_C);
	if(opc==2 && !o2) UNALLOCATED(ENC_UNALLOCATED_681_SVE_FP_Z2OP_P_ZD_C);
	UNMATCHED;
}
...
int decode_iclass_sve_fp_z2op_p_zd_d(context *ctx, Instruction *dec)
{
	...
	if(opc==1 && !o2 && !o3) UNALLOCATED(ENC_UNALLOCATED_689_SVE_FP_Z2OP_P_ZD_D);
	if(opc==2 && o2 && o3) UNALLOCATED(ENC_UNALLOCATED_688_SVE_FP_Z2OP_P_ZD_D);
	if(opc==3 && !o2 && o3) UNALLOCATED(ENC_UNALLOCATED_687_SVE_FP_Z2OP_P_ZD_D);
	if(!opc && !o2 && HasSVE2p2() && HasSME2p2()) return flogb_z_p_z(ctx, dec); // -> flogb_z_p_z_z
	if(!opc && o2) UNALLOCATED(ENC_UNALLOCATED_685_SVE_FP_Z2OP_P_ZD_D);
	if(opc==2 && !o2) UNALLOCATED(ENC_UNALLOCATED_686_SVE_FP_Z2OP_P_ZD_D);
	UNMATCHED;
}
...
{
	uint32_t opc=(INSWORD>>22)&3, opc2=(INSWORD>>10)&3;
	if(opc==3 && !opc2 && HasSVE() && HasCPA()) return mlapt_z_zzz(ctx, dec); // -> mlapt_z_zzz_
	if(opc==3 && opc2==2 && HasSVE() && HasCPA()) return madpt_z_zzz(ctx, dec); // -> madpt_z_zzz_
	if(opc==3 && opc2&1) UNALLOCATED(ENC_UNALLOCATED_691_SVE_PTR_MULADD_UNPRED);
	if(opc!=3) UNALLOCATED(ENC_UNALLOCATED_690_SVE_PTR_MULADD_UNPRED);
	UNMATCHED;
}
