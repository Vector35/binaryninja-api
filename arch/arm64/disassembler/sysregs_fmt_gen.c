...
const char *get_system_register_name(enum SystemReg sr)
{
	switch(sr) {
		...
		case REG_CLAIMSET_EL1: return "claimset_el1";
		case REG_CLAIMCLR_EL1: return "claimclr_el1";
		case REG_AUTHSTAT_EL1: return "authstat_el1";
		...
		case REG_MDDTR_EL0: return "mddtr_el0";
		case REG_MDDTRTX_EL0: return "mddtrtx_el0";
		...
		case REG_SCTLR_EL21: return "sctlr_el21";
		case REG_ACTLR_EL21: return "actlr_el21";
		case REG_CPTR_EL21: return "cptr_el21";
		...
		case REG_SMCR_EL21: return "smcr_el21";
		case REG_TTBR0_EL21: return "ttbr0_el21";
		case REG_TTBR1_EL21: return "ttbr1_el21";
		case REG_TCR_EL21: return "tcr_el21";
		case REG_APIAKEYLO_EL21: return "apiakeylo_el21";
		case REG_APIAKEYHI_EL21: return "apiakeyhi_el21";
		case REG_APIBKEYLO_EL21: return "apibkeylo_el21";
		case REG_APIBKEYHI_EL21: return "apibkeyhi_el21";
		case REG_APDAKEYLO_EL21: return "apdakeylo_el21";
		case REG_APDAKEYHI_EL21: return "apdakeyhi_el21";
		case REG_APDBKEYLO_EL21: return "apdbkeylo_el21";
		case REG_APDBKEYHI_EL21: return "apdbkeyhi_el21";
		case REG_APGAKEYLO_EL21: return "apgakeylo_el21";
		case REG_APGAKEYHI_EL21: return "apgakeyhi_el21";
		case REG_SPSR_EL21: return "spsr_el21";
		case REG_ELR_EL21: return "elr_el21";
		case REG_SP_EL0: return "sp_el0";
		case REG_SPSEL: return "spsel";
		case REG_NESTEDCURRENTEL: return "nestedcurrentel";
		case REG_PAN: return "pan";
		case REG_UAO: return "uao";
		case REG_ICV_PMR_EL1: return "icv_pmr_el1";
		case REG_AFSR0_EL21: return "afsr0_el21";
		case REG_AFSR1_EL21: return "afsr1_el21";
		case REG_ESR_EL21: return "esr_el21";
		...
		case REG_FAR_EL21: return "far_el21";
		...
		case REG_MAIR_EL21: return "mair_el21";
		case REG_AMAIR_EL21: return "amair_el21";
		...
		case REG_CTRR_C_LWR_EL21: return "ctrr_c_lwr_el21";
		case REG_CTRR_C_UPR_EL21: return "ctrr_c_upr_el21";
		case REG_CTRR_D_LWR_EL21: return "ctrr_d_lwr_el21";
		case REG_CTRR_D_UPR_EL21: return "ctrr_d_upr_el21";
		...
		case REG_CTRR_C_CTL_EL21: return "ctrr_c_ctl_el21";
		case REG_CTRR_D_CTL_EL21: return "ctrr_d_ctl_el21";
		...
		case REG_CTXR_A_LWR_EL21: return "ctxr_a_lwr_el21";
		case REG_CTXR_A_UPR_EL21: return "ctxr_a_upr_el21";
		case REG_CTXR_B_LWR_EL21: return "ctxr_b_lwr_el21";
		case REG_CTXR_B_UPR_EL21: return "ctxr_b_upr_el21";
		case REG_CTXR_C_LWR_EL21: return "ctxr_c_lwr_el21";
		case REG_CTXR_C_UPR_EL21: return "ctxr_c_upr_el21";
		case REG_CTXR_D_LWR_EL21: return "ctxr_d_lwr_el21";
		case REG_CTXR_D_UPR_EL21: return "ctxr_d_upr_el21";
		...
		case REG_CTXR_A_CTL_EL21: return "ctxr_a_ctl_el21";
		case REG_CTXR_B_CTL_EL21: return "ctxr_b_ctl_el21";
		case REG_CTXR_C_CTL_EL21: return "ctxr_c_ctl_el21";
		case REG_CTXR_D_CTL_EL21: return "ctxr_d_ctl_el21";
		...
		case REG_VBAR_EL21: return "vbar_el21";
		...
		case REG_ICV_BPR1_EL1: return "icv_bpr1_el1";
		...
		case REG_CONTEXTIDR_EL21: return "contextidr_el21";
		case REG_TPIDR_EL1: return "tpidr_el1";
		case REG_SCXTNUM_EL21: return "scxtnum_el21";
		case REG_REDIR_CNTKCTL_EL1: return "redir_cntkctl_el1";
		...
		case REG_CCSIDRPL1_I_EL1: return "ccsidrpl1_i_el1";
		...
		case REG_LD_LATPROF_CTL_EL21: return "ld_latprof_ctl_el21";
		case REG_AON_CPU_MSTALL_CTL01_EL1: return "aon_cpu_mstall_ctl01_el1";
		case REG_PM_MEMFLT_CTL23_EL1: return "pm_memflt_ctl23_el1";
		case REG_REDIR_ACNTV_CTL_EL0: return "redir_acntv_ctl_el0";
		case REG_LCL_ACNTVCTSS_NOREDIR_EL0: return "lcl_acntvctss_noredir_el0";
		case REG_PMCR1_EL21: return "pmcr1_el21";
		...
		case REG_AGTCNTRDIR_EL21: return "agtcntrdir_el21";
		...
		case REG_REDIR_ACNTHP_CVAL_EL2: return "redir_acnthp_cval_el2";
		case REG_LCL_CNTVCT_NOREDIR_EL0: return "lcl_cntvct_noredir_el0";
		...
		case REG_REDIR_ACNTHP_TVAL_EL2: return "redir_acnthp_tval_el2";
		case REG_LCL_CNTPCTSS_NOREDIR_EL0: return "lcl_cntpctss_noredir_el0";
		...
		case REG_REDIR_ACNTHP_CTL_EL2: return "redir_acnthp_ctl_el2";
		case REG_LCL_CNTVCTSS_NOREDIR_EL0: return "lcl_cntvctss_noredir_el0";
		...
		case REG_REDIR_ACNTHV_CVAL_EL2: return "redir_acnthv_cval_el2";
		...
		case REG_REDIR_ACNTHV_TVAL_EL2: return "redir_acnthv_tval_el2";
		...
		case REG_REDIR_ACNTHV_CTL_EL2: return "redir_acnthv_ctl_el2";
		...
		case REG_REDIR_ACNTFRQ_EL0: return "redir_acntfrq_el0";
		case REG_CNTP_TVAL_NOREDIR_EL0: return "cntp_tval_noredir_el0";
		case REG_LCL_CNTPCT_NOREDIR_EL0: return "lcl_cntpct_noredir_el0";
		...
		case REG_REDIR_ACNTP_CVAL_EL0: return "redir_acntp_cval_el0";
		case REG_CNTV_CVAL_NOREDIR_EL0: return "cntv_cval_noredir_el0";
		case REG_LCL_ACNTPCT_NOREDIR_EL0: return "lcl_acntpct_noredir_el0";
		case REG_AON_CPU_MSTALL_CTR3_EL1: return "aon_cpu_mstall_ctr3_el1";
		case REG_REDIR_ACNTP_TVAL_EL0: return "redir_acntp_tval_el0";
		...
		case REG_REDIR_ACNTP_CTL_EL0: return "redir_acntp_ctl_el0";
		...
		case REG_REDIR_ACNTV_CVAL_EL0: return "redir_acntv_cval_el0";
		case REG_LCL_ACNTVCT_NOREDIR_EL0: return "lcl_acntvct_noredir_el0";
		case REG_PMCR_BVRNG5_EL1: return "pmcr_bvrng5_el1";
		case REG_AON_CPU_MSTALL_CTR7_EL1: return "aon_cpu_mstall_ctr7_el1";
		case REG_REDIR_ACNTV_TVAL_EL0: return "redir_acntv_tval_el0";
		case REG_LCL_ACNTPCTSS_NOREDIR_EL0: return "lcl_acntpctss_noredir_el0";
		...
		case REG_REDIR_CNTFRQ_EL0: return "redir_cntfrq_el0";
		case REG_REDIR_LCL_CNTPCT_EL0: return "redir_lcl_cntpct_el0";
		case REG_REDIR_LCL_CNTVCT_EL0: return "redir_lcl_cntvct_el0";
		case REG_REDIR_LCL_CNTPCTSS_EL0: return "redir_lcl_cntpctss_el0";
		case REG_REDIR_LCL_CNTVCTSS_EL0: return "redir_lcl_cntvctss_el0";
		case REG_REDIR_CNTP_TVAL_EL0: return "redir_cntp_tval_el0";
		case REG_REDIR_CNTP_CTL_EL0: return "redir_cntp_ctl_el0";
		case REG_REDIR_CNTP_CVAL_EL0: return "redir_cntp_cval_el0";
		case REG_REDIR_CNTV_TVAL_EL0: return "redir_cntv_tval_el0";
		case REG_REDIR_CNTV_CTL_EL0: return "redir_cntv_ctl_el0";
		case REG_REDIR_CNTV_CVAL_EL0: return "redir_cntv_cval_el0";
		...
		case REG_SPSR_NV_EL21: return "spsr_nv_el21";
		case REG_ELR_NV_EL21: return "elr_nv_el21";
		...
		case REG_REDIR_CNTHCTL_EL2: return "redir_cnthctl_el2";
		case REG_REDIR_CNTHP_TVAL_EL2: return "redir_cnthp_tval_el2";
		case REG_REDIR_CNTHP_CTL_EL2: return "redir_cnthp_ctl_el2";
		case REG_REDIR_CNTHP_CVAL_EL2: return "redir_cnthp_cval_el2";
		case REG_REDIR_CNTHV_TVAL_EL2: return "redir_cnthv_tval_el2";
		case REG_REDIR_CNTHV_CTL_EL2: return "redir_cnthv_ctl_el2";
		case REG_REDIR_CNTHV_CVAL_EL2: return "redir_cnthv_cval_el2";
		...
		case REG_APCTL_EL21: return "apctl_el21";
		case REG_KERNKEYLO_EL21: return "kernkeylo_el21";
		case REG_KERNKEYHI_EL21: return "kernkeyhi_el21";
		case REG_VMSA_LOCK_EL1: return "vmsa_lock_el1";
		case REG_AMX_STATE_T_EL1: return "amx_state_t_el1";
		case REG_AMX_CONFIG_EL21: return "amx_config_el21";
		case REG_VMSA_LOCK_EL2: return "vmsa_lock_el2";
		case REG_CTRR_B_UPR_EL21: return "ctrr_b_upr_el21";
		case REG_CTRR_B_LWR_EL21: return "ctrr_b_lwr_el21";
		case REG_SP_SETUP_GL21: return "sp_setup_gl21";
		case REG_SP_SETUP_GL2: return "sp_setup_gl2";
		case REG_CTRR_B_CTL_EL21: return "ctrr_b_ctl_el21";
		case REG_CTRR_A_LWR_EL21: return "ctrr_a_lwr_el21";
		case REG_CTRR_A_UPR_EL21: return "ctrr_a_upr_el21";
		case REG_CTRR_A_CTL_EL21: return "ctrr_a_ctl_el21";
		...
		case REG_REDIR_ACNTKCTL_EL1: return "redir_acntkctl_el1";
		...
		case REG_REDIR_LCL_ACNTPCTSS_EL0: return "redir_lcl_acntpctss_el0";
		case REG_REDIR_LCL_ACNTVCTSS_EL0: return "redir_lcl_acntvctss_el0";
		...
		case REG_REDIR_LCL_ACNTPCT_EL0: return "redir_lcl_acntpct_el0";
		case REG_REDIR_LCL_ACNTVCT_EL0: return "redir_lcl_acntvct_el0";
		case REG_ACFG_EL1: return "acfg_el1";
		case REG_AHCR_EL2: return "ahcr_el2";
		case REG_APL_INTSTATUS_EL21: return "apl_intstatus_el21";
		case REG_APL_INTSTATUS_EL2: return "apl_intstatus_el2";
		case REG_REDIR_ACNTHCTL_EL2: return "redir_acnthctl_el2";
		case REG_JAPIAKEYLO_NV_EL21: return "japiakeylo_nv_el21";
		case REG_JAPIAKEYHI_NV_EL21: return "japiakeyhi_nv_el21";
		case REG_JAPIBKEYLO_NV_EL21: return "japibkeylo_nv_el21";
		case REG_JAPIBKEYHI_NV_EL21: return "japibkeyhi_nv_el21";
		case REG_JAPIAKEYLO_EL21: return "japiakeylo_el21";
		case REG_JAPIAKEYHI_EL21: return "japiakeyhi_el21";
		case REG_JAPIBKEYLO_EL21: return "japibkeylo_el21";
		case REG_JAPIBKEYHI_EL21: return "japibkeyhi_el21";
		...
		case REG_JRANGE_EL21: return "jrange_el21";
		case REG_JRANGE_EL12: return "jrange_el12";
		case REG_JCTL_EL2: return "jctl_el2";
		case REG_JCTL_EL21: return "jctl_el21";
		...
		case REG_PROD_TRC_CORE_CFG_EL21: return "prod_trc_core_cfg_el21";
		...
		case REG_PROD_TRC_CTL_EL21: return "prod_trc_ctl_el21";
		case REG_PROD_TRC_STRM_BASE0_GL21: return "prod_trc_strm_base0_gl21";
		case REG_PROD_TRC_STRM_BASE1_GL21: return "prod_trc_strm_base1_gl21";
		case REG_PROD_TRC_STRM_FIQ_EL21: return "prod_trc_strm_fiq_el21";
		case REG_CPU_OVRD: return "cpu_ovrd";
		case REG_PBLK_EXE_ST: return "pblk_exe_st";
		case REG_PROD_TRC_CORE_GL_CTL_GL21: return "prod_trc_core_gl_ctl_gl21";
		...
		case REG_PROD_TRC_BUF_RESTORE0_GL21: return "prod_trc_buf_restore0_gl21";
		case REG_PROD_TRC_BUF_RESTORE1_GL21: return "prod_trc_buf_restore1_gl21";
		case REG_PROD_TRC_EN_GL21: return "prod_trc_en_gl21";
		...
		case REG_AFSR1_GL21: return "afsr1_gl21";
		...
		case REG_SP_GL11_GL21: return "sp_gl11_gl21";
		case REG_MMU_SESR_EL2: return "mmu_sesr_el2";
		case REG_SPRR_CONFIG_EL21: return "sprr_config_el21";
		case REG_HPFAR_GL2: return "hpfar_gl2";
		case REG_GXF_CONFIG_EL21: return "gxf_config_el21";
		case REG_SPRR_AMRANGE_EL1: return "sprr_amrange_el1";
		case REG_GXF_CONFIG_EL2: return "gxf_config_el2";
		case REG_SPRR_UPERM_EL02: return "sprr_uperm_el02";
		case REG_SPRR_PPERM_EL21: return "sprr_pperm_el21";
		...
		case REG_SPRR_PMPRR_EL21: return "sprr_pmprr_el21";
		...
		case REG_SPRR_PPERM_SH01_EL21: return "sprr_pperm_sh01_el21";
		case REG_SPRR_PPERM_SH02_EL21: return "sprr_pperm_sh02_el21";
		case REG_SPRR_PPERM_SH03_EL21: return "sprr_pperm_sh03_el21";
		case REG_SPRR_PPERM_SH04_EL21: return "sprr_pperm_sh04_el21";
		case REG_SPRR_PPERM_SH05_EL21: return "sprr_pperm_sh05_el21";
		case REG_SPRR_PPERM_SH06_EL21: return "sprr_pperm_sh06_el21";
		case REG_SPRR_PPERM_SH07_EL21: return "sprr_pperm_sh07_el21";
		...
		case REG_GXF_ENTRY_EL21: return "gxf_entry_el21";
		case REG_GXF_PABENTRY_EL21: return "gxf_pabentry_el21";
		case REG_ASPSR_EL21: return "aspsr_el21";
		case REG_ADSPSR_EL0: return "adspsr_el0";
		case REG_PMCR1_GL2: return "pmcr1_gl2";
		case REG_ASPSR_NV_EL21: return "aspsr_nv_el21";
		case REG_PMCR1_GL21: return "pmcr1_gl21";
		...
		case REG_VBAR_GL21: return "vbar_gl21";
		case REG_SPSR_GL21: return "spsr_gl21";
		case REG_ASPSR_GL21: return "aspsr_gl21";
		case REG_ESR_GL21: return "esr_gl21";
		case REG_ELR_GL21: return "elr_gl21";
		case REG_FAR_GL21: return "far_gl21";
		...
		case REG_APSTS_NV1_EL1: return "apsts_nv1_el1";
		case REG_KERNKEYLO_NV_EL21: return "kernkeylo_nv_el21";
		case REG_KERNKEYHI_NV_EL21: return "kernkeyhi_nv_el21";
		case REG_ASPSR_EL12: return "aspsr_el12";
		case REG_APIAKEYLO_NV_EL21: return "apiakeylo_nv_el21";
		case REG_APIAKEYHI_NV_EL21: return "apiakeyhi_nv_el21";
		case REG_APIBKEYLO_NV_EL21: return "apibkeylo_nv_el21";
		case REG_APIBKEYHI_NV_EL21: return "apibkeyhi_nv_el21";
		case REG_APDAKEYLO_NV_EL21: return "apdakeylo_nv_el21";
		case REG_APDAKEYHI_NV_EL21: return "apdakeyhi_nv_el21";
		case REG_APDBKEYLO_NV_EL21: return "apdbkeylo_nv_el21";
		case REG_APDBKEYHI_NV_EL21: return "apdbkeyhi_nv_el21";
		case REG_APGAKEYLO_NV_EL21: return "apgakeylo_nv_el21";
		case REG_APGAKEYHI_NV_EL21: return "apgakeyhi_nv_el21";
