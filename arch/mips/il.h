...
enum MipsIntrinsic : uint32_t
{
		...
		// Intrinsic IDs are persisted in IL. Append new entries here so the
		// numeric values of existing intrinsics remain stable.
		MIPS_INTRIN_CFC1,
		MIPS_INTRIN_CFC2,
		MIPS_INTRIN_COP2,
		MIPS_INTRIN_CTC1,
		...
		MIPS_INTRIN_WRPGPR,
		MIPS_INTRIN_SUB_PS,
		// Signed fixed-point conversions, rounding to nearest with ties to even.
