...
function(generate_python_bindings)
	...
	# To support concurrent builds, generated modules must be local to the build
	set(PYTHON_GENERATED_DIR ${PROJECT_BINARY_DIR}/generated)
	set(CORE_SOURCE_PATH ${PYTHON_GENERATED_DIR}/${ARGS_CORE_OUTPUT_FILE})
	set(ENUMS_SOURCE_PATH ${PYTHON_GENERATED_DIR}/${ARGS_ENUMS_OUTPUT_FILE})
	...
	add_custom_command(
		...
		COMMAND ${CMAKE_COMMAND} -E make_directory ${PYTHON_GENERATED_DIR}
