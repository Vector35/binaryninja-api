...
|pluginManager|Unofficial 3rd Party Plugin Repository URLs|Specify URLs of third party plugin repositories|`array`|`[]`|[`SettingsUserScope`]|<a id='pluginManager.unofficialUrls'>pluginManager.unofficialUrls</a>|
