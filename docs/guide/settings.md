...
|corePlugins|IDB Import Plugin (Beta)|Enable the built-in IDB import plugin.|`boolean`|`True`|[`SettingsUserScope`]|<a id='corePlugins.idbImport'>corePlugins.idbImport</a>|
