...
`uv sync` installs [zensical], [sphinx], and [breathe]. It does not install Doxygen or Binary Ninja.
...
with paths shown relative to the repository root.
