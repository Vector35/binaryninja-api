...
- **Keybindings**: [`api/docs/manual/files/ida-keybindings.json`](https://github.com/Vector35/binaryninja-api/blob/dev/docs/manual/files/ida-keybindings.json)
- **Settings**: [`api/docs/manual/files/ida-settings.json`](https://github.com/Vector35/binaryninja-api/blob/dev/docs/manual/files/ida-settings.json)
