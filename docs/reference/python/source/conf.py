...
if platform.system() == "Darwin":
	bnpath = checkout_root / "build" / "out" / "binaryninja.app" / "Contents" / "Resources" / "python"
else:
	bnpath = checkout_root / "build" / "out" / "python"

if not bnpath.exists():
	if platform.system() == "Darwin":
		bnpath = checkout_root / "out" / "binaryninja.app" / "Contents" / "Resources" / "python"
	else:
		bnpath = checkout_root / "out" / "python"

sys.path.insert(0, str(bnpath))
...
html_logo = u'../../../img/wordmark-white.svg'

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
#
html_favicon = u'../../../img/favicon.ico'
