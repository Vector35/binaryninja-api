...
# -------------------------------------------------------
# _BNWARPConstraintGetGUID

_BNWARPConstraintGetGUID = core.BNWARPConstraintGetGUID
_BNWARPConstraintGetGUID.restype = BNWARPConstraintGUID
_BNWARPConstraintGetGUID.argtypes = [
		ctypes.POINTER(BNWARPConstraint),
	]


# noinspection PyPep8Naming
def BNWARPConstraintGetGUID(
		constraint: ctypes.POINTER(BNWARPConstraint)
		) -> BNWARPConstraintGUID:
	return _BNWARPConstraintGetGUID(constraint)


# -------------------------------------------------------
# _BNWARPConstraintGetOffset

_BNWARPConstraintGetOffset = core.BNWARPConstraintGetOffset
_BNWARPConstraintGetOffset.restype = ctypes.c_longlong
_BNWARPConstraintGetOffset.argtypes = [
		ctypes.POINTER(BNWARPConstraint),
	]


# noinspection PyPep8Naming
def BNWARPConstraintGetOffset(
		constraint: ctypes.POINTER(BNWARPConstraint)
		) -> int:
	return _BNWARPConstraintGetOffset(constraint)
...
_BNWARPFreeConstraintList.argtypes = [
		ctypes.POINTER(ctypes.POINTER(BNWARPConstraint)),
		ctypes.c_ulonglong,
	]
...
def BNWARPFreeConstraintList(
		constraints: ctypes.POINTER(ctypes.POINTER(BNWARPConstraint)), 
		count: int
		) -> None:
...
# -------------------------------------------------------
# _BNWARPFreeConstraintReference

_BNWARPFreeConstraintReference = core.BNWARPFreeConstraintReference
_BNWARPFreeConstraintReference.restype = None
_BNWARPFreeConstraintReference.argtypes = [
		ctypes.POINTER(BNWARPConstraint),
	]


# noinspection PyPep8Naming
def BNWARPFreeConstraintReference(
		constraint: ctypes.POINTER(BNWARPConstraint)
		) -> None:
	return _BNWARPFreeConstraintReference(constraint)
...
_BNWARPFunctionGetConstraints.restype = ctypes.POINTER(ctypes.POINTER(BNWARPConstraint))
...
def BNWARPFunctionGetConstraints(
		function: ctypes.POINTER(BNWARPFunction), 
		count: ctypes.POINTER(ctypes.c_ulonglong)
		) -> Optional[ctypes.POINTER(ctypes.POINTER(BNWARPConstraint))]:
...
# -------------------------------------------------------
# _BNWARPNewConstraintReference

_BNWARPNewConstraintReference = core.BNWARPNewConstraintReference
_BNWARPNewConstraintReference.restype = ctypes.POINTER(BNWARPConstraint)
_BNWARPNewConstraintReference.argtypes = [
		ctypes.POINTER(BNWARPConstraint),
	]


# noinspection PyPep8Naming
def BNWARPNewConstraintReference(
		constraint: ctypes.POINTER(BNWARPConstraint)
		) -> Optional[ctypes.POINTER(BNWARPConstraint)]:
	result = _BNWARPNewConstraintReference(constraint)
	if not result:
		return None
	return result
