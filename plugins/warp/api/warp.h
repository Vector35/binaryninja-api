...
namespace Warp {
	...
	class Constraint : public WarpRefCountObject<BNWARPConstraint, BNWARPNewConstraintReference,
				BNWARPFreeConstraintReference>
	{
	public:
		explicit Constraint(BNWARPConstraint *constraint);

		ConstraintGUID GetGUID() const;
	...
	public:
		...
		std::vector<Ref<Constraint>> GetConstraints() const;
