...
extern "C"
{
    ...
    WARP_FFI_API BNWARPConstraintGUID BNWARPConstraintGetGUID(BNWARPConstraint* constraint);
    WARP_FFI_API int64_t BNWARPConstraintGetOffset(BNWARPConstraint* constraint);

    WARP_FFI_API BNWARPConstraint* BNWARPNewConstraintReference(BNWARPConstraint* constraint);
    WARP_FFI_API void BNWARPFreeConstraintReference(BNWARPConstraint* constraint);
