    ...
    def perform_get_expr_text(
        ...
        with tokens.expr(instr):
            if instr.operation == HighLevelILOperation.HLIL_BLOCK:
                ...
                if (instr.init.operation == HighLevelILOperation.HLIL_VAR_INIT and
                        ...
                        instr.condition.left.var == instr.init.dest and
                    ...
                    var = instr.init.dest
                    tokens.append(InstructionTextToken(InstructionTextTokenType.LocalVariableToken, var.name,
...
class PseudoPythonFunctionType(LanguageRepresentationFunctionType):
    ...
    def function_type_tokens(self, func: Function, settings: DisassemblySettings) -> DisassemblyTextLine:
        ...
        tokens.append(InstructionTextToken(InstructionTextTokenType.CodeSymbolToken, func.name))
