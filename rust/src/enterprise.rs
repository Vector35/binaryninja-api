...
pub fn server_username() -> String {
    unsafe { BnString::to_string(binaryninjacore_sys::BNGetEnterpriseServerUsername()) }
}

// TODO: If "" string return None
pub fn server_url() -> String {
    unsafe { BnString::to_string(binaryninjacore_sys::BNGetEnterpriseServerUrl()) }
}
...
pub fn server_name() -> String {
    unsafe { BnString::to_string(binaryninjacore_sys::BNGetEnterpriseServerName()) }
}

pub fn server_id() -> String {
    unsafe { BnString::to_string(binaryninjacore_sys::BNGetEnterpriseServerId()) }
}
...
pub fn server_build_id() -> String {
    unsafe { BnString::to_string(binaryninjacore_sys::BNGetEnterpriseServerBuildId()) }
}

pub fn server_token() -> String {
    unsafe { BnString::to_string(binaryninjacore_sys::BNGetEnterpriseServerToken()) }
}
...
pub fn server_last_error() -> String {
    unsafe { BnString::to_string(binaryninjacore_sys::BNGetEnterpriseServerLastError()) }
}
