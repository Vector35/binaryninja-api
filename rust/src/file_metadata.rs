...
impl FileMetadata {
    ...
    pub fn begin_undo_actions(&self, anonymous_allowed: bool) -> String {
        unsafe { BnString::to_string(BNBeginUndoActions(self.handle, anonymous_allowed)) }
    }
    ...
    pub fn current_view(&self) -> String {
        unsafe { BnString::to_string(BNGetCurrentView(self.handle)) }
    }
