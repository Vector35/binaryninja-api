...
pub fn version() -> String {
    unsafe { BnString::to_string(BNGetVersionString()) }
}
...
pub fn serial_number() -> String {
    unsafe { BnString::to_string(BNGetSerialNumber()) }
}
...
pub fn licensed_user_email() -> String {
    unsafe { BnString::to_string(BNGetLicensedUserEmail()) }
}
...
pub fn product() -> String {
    unsafe { BnString::to_string(BNGetProduct()) }
}

pub fn product_type() -> String {
    unsafe { BnString::to_string(BNGetProductType()) }
}
