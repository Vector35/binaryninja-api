    ...
    V: NonSSAVariant,
{
    pub fn info(&self) -> InstrInfo<'func, A, M, NonSSA<V>> {
        ...
        match op.operation {
            MLIL_NOP => InstrInfo::Nop(Operation::new(self.function, op)),
            ...
            MLIL_JUMP | MLIL_RET_HINT => InstrInfo::Jump(Operation::new(self.function, op)),
            MLIL_JUMP_TO => InstrInfo::JumpTo(Operation::new(self.function, op)),
            ...
            MLIL_RET => InstrInfo::Ret(Operation::new(self.function, op)),
            MLIL_NORET => InstrInfo::NoRet(Operation::new(self.function, op)),
            MLIL_IF => InstrInfo::If(Operation::new(self.function, op)),
            MLIL_GOTO => InstrInfo::Goto(Operation::new(self.function, op)),
            MLIL_BP => InstrInfo::Bp(Operation::new(self.function, op)),
            MLIL_TRAP => InstrInfo::Trap(Operation::new(self.function, op)),
            MLIL_UNDEF => InstrInfo::Undef(Operation::new(self.function, op)),
            MLIL_UNIMPL => InstrInfo::Unimpl(Operation::new(self.function, op)),
