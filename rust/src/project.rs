...
impl Project {
    ...
    pub fn id(&self) -> String {
        unsafe { BnString::to_string(BNProjectGetId(self.handle.as_ptr())) }
    }

    /// Get the path of the project
    pub fn path(&self) -> String {
        unsafe { BnString::to_string(BNProjectGetPath(self.handle.as_ptr())) }
    }

    /// Get the name of the project
    pub fn name(&self) -> String {
        unsafe { BnString::to_string(BNProjectGetName(self.handle.as_ptr())) }
    }
    ...
    pub fn description(&self) -> String {
        unsafe { BnString::to_string(BNProjectGetDescription(self.handle.as_ptr())) }
    }
