...
impl ProjectFile {
    ...
    pub fn path_on_disk(&self) -> String {
        unsafe { BnString::to_string(BNProjectFileGetPathOnDisk(self.handle.as_ptr())) }
    }
    ...
    pub fn id(&self) -> String {
        unsafe { BnString::to_string(BNProjectFileGetId(self.handle.as_ptr())) }
    }

    /// Get the name of this file
    pub fn name(&self) -> String {
        unsafe { BnString::to_string(BNProjectFileGetName(self.handle.as_ptr())) }
    }
    ...
    pub fn description(&self) -> String {
        unsafe { BnString::to_string(BNProjectFileGetDescription(self.handle.as_ptr())) }
    }
