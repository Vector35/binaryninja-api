...
impl ProjectFolder {
    ...
    pub fn id(&self) -> String {
        unsafe { BnString::to_string(BNProjectFolderGetId(self.handle.as_ptr())) }
    }

    /// Get the name of this folder
    pub fn name(&self) -> String {
        unsafe { BnString::to_string(BNProjectFolderGetName(self.handle.as_ptr())) }
    }
    ...
    pub fn description(&self) -> String {
        unsafe { BnString::to_string(BNProjectFolderGetDescription(self.handle.as_ptr())) }
    }
