...
impl Section {
    ...
    pub fn name(&self) -> String {
        unsafe { BnString::to_string(BNSectionGetName(self.handle)) }
    }

    pub fn section_type(&self) -> String {
        unsafe { BnString::to_string(BNSectionGetType(self.handle)) }
    }
    ...
    pub fn linked_section(&self) -> String {
        unsafe { BnString::to_string(BNSectionGetLinkedSection(self.handle)) }
    }

    pub fn info_section(&self) -> String {
        unsafe { BnString::to_string(BNSectionGetInfoSection(self.handle)) }
    }
