...
impl Settings {
    ...
    pub fn serialize_schema(&self) -> String {
        unsafe { BnString::to_string(BNSettingsSerializeSchema(self.handle)) }
    }
    ...
    pub fn get_string_with_opts<S: BnStrCompatible>(
        ...
        unsafe {
            BnString::to_string(BNSettingsGetString(
                self.handle,
                key.as_ref().as_ptr() as *mut _,
                view_ptr,
                func_ptr,
    ...
    pub fn get_json_with_opts<S: BnStrCompatible>(
        ...
        unsafe {
            BnString::to_string(BNSettingsGetJson(
                self.handle,
                key.as_ref().as_ptr() as *mut _,
                view_ptr,
                func_ptr,
    ...
    pub fn get_property_string<S: BnStrCompatible>(&self, key: S, property: S) -> String {
        ...
        unsafe {
            BnString::to_string(BNSettingsQueryPropertyString(
                self.handle,
                key.as_ref().as_ptr() as *mut _,
