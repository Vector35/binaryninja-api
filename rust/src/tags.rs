...
impl Tag {
    ...
    pub fn id(&self) -> String {
        unsafe { BnString::to_string(BNTagGetId(self.handle)) }
    }

    pub fn data(&self) -> String {
        unsafe { BnString::to_string(BNTagGetData(self.handle)) }
    }
...
impl TagType {
    ...
    pub fn id(&self) -> String {
        unsafe { BnString::to_string(BNTagTypeGetId(self.handle)) }
    }

    pub fn icon(&self) -> String {
        unsafe { BnString::to_string(BNTagTypeGetIcon(self.handle)) }
    }
    ...
    pub fn name(&self) -> String {
        unsafe { BnString::to_string(BNTagTypeGetName(self.handle)) }
    }
