...
public:
	...
	static std::vector<TransformContextRef> openContainerFile(const QString& path, bool forceShowDialog = false, bool* outOpenWithOptions = nullptr, ProjectFileRef projectFile = nullptr);
};
