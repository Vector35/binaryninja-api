...
#define BN_MINIMUM_UI_ABI_VERSION 18
...
typedef BinaryNinja::Ref<BinaryNinja::DatabaseObject> DatabaseObjectRef;
typedef BinaryNinja::Ref<BinaryNinja::DebugInfo> DebugInfoRef;
typedef BinaryNinja::Ref<BinaryNinja::DiffObject> DiffObjectRef;
