...
class BINARYNINJAUIAPI View
{
  ...
  public:
	...
	virtual bool findNextData(uint64_t start, uint64_t end, const BinaryNinja::DataBuffer& data, uint64_t& addr,
	    const BNFindFlags& flags, const std::function<bool(size_t current, size_t total)>& cb);
	...
	virtual bool findAllData(uint64_t start, uint64_t end, const BinaryNinja::DataBuffer& data, const BNFindFlags& flags,
	    const std::function<bool(size_t current, size_t total)>& cb,
	...
	virtual bool findAllText(uint64_t start, uint64_t end, const std::string& data, DisassemblySettingsRef settings,
	    const BNFindFlags& flags, BNFunctionGraphType graph, const std::function<bool(size_t current, size_t total)>& cb,
